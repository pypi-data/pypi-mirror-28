...
class Kogu(object):
    ...
    def update_parameters(cls, dic, output=False):
        ...
        * **output** - A flag indicating whether to print the passed parameters to stdout as well.
        """
        try:
