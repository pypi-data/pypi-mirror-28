def analysis():
	...
	file_name = "CPU_Utilization_of_Canny"
	...
	file_name = "Comparison_of_CPU_A15_user"
	plt.savefig(results_dir + file_name, format='eps', dpi=1000, bbox_inches='tight')
	...
	file_name = "Comparison_of_CPU_A15_System"
	plt.savefig(results_dir + file_name, format='eps', dpi=1000, bbox_inches='tight')
	...
	file_name = "Comparison_of_CPU_A7_user"
	plt.savefig(results_dir + file_name, format='eps', dpi=1000, bbox_inches='tight')
	...
	file_name = "Comparison_of_CPU_A7_System"
	plt.savefig(results_dir + file_name, format='eps', dpi=1000, bbox_inches='tight')
	...
	file_name = "Comparison_of_CPU_Time_Idle"
	plt.savefig(results_dir + file_name, format='eps', dpi=1000, bbox_inches='tight')
	...
	file_name = "Memory_Utilization_of_Canny"
	plt.savefig(results_dir + file_name, format='eps', dpi=1000, bbox_inches='tight')
	...
	file_name = "Memory_Utilization_of_Harris"
	plt.savefig(results_dir + file_name, format='eps', dpi=1000, bbox_inches='tight')
	...
	file_name = "Memory_Utilization_of_Optical"
	plt.savefig(results_dir + file_name, format='eps', dpi=1000, bbox_inches='tight')
