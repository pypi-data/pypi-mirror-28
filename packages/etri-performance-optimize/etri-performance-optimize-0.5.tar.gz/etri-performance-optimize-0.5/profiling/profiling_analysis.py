def analysis():
	...
	file_name = "CPU_Utilization_of_Canny.eps"
	plt.savefig(results_dir + file_name, format='eps', dpi=1000, bbox_inches='tight')
	...
	file_name = "Comparison_of_CPU_A15_user.eps"
	plt.savefig(results_dir + file_name, format='eps', dpi=1000, bbox_inches='tight')
	...
	file_name = "Comparison_of_CPU_A15_System.eps"
	plt.savefig(results_dir + file_name, format='eps', dpi=1000, bbox_inches='tight')
	...
	file_name = "Comparison_of_CPU_A7_user.eps"
	plt.savefig(results_dir + file_name, format='eps', dpi=1000, bbox_inches='tight')
	...
	file_name = "Comparison_of_CPU_A7_System.eps"
	plt.savefig(results_dir + file_name, format='eps', dpi=1000, bbox_inches='tight')
	...
	file_name = "Comparison_of_CPU_Time_Idle.eps"
	plt.savefig(results_dir + file_name, format='eps', dpi=1000, bbox_inches='tight')
	...
	file_name = "Memory_Utilization_of_Canny.eps"
	plt.savefig(results_dir + file_name, format='eps', dpi=1000, bbox_inches='tight')
	...
	file_name = "Memory_Utilization_of_Harris.eps"
	plt.savefig(results_dir + file_name, format='eps', dpi=1000, bbox_inches='tight')
	...
	file_name = "Memory_Utilization_of_Optical.eps"
	plt.savefig(results_dir + file_name, format='eps', dpi=1000, bbox_inches='tight')
	#plt.savefig("./figures/Memory_Utilization_of_Optical.eps", format='eps', dpi=1000, bbox_inches='tight')

	print("saved results in %s"%results_dir)

	# return((u'analysis completed!'))
