...
class MlAssetsCreateModelInput(object):
    ...
    def experiment_url(self):
        """
        Gets the experiment_url of this MlAssetsCreateModelInput.
        The URL to the experiment which was used to create this model

        :return: The experiment_url of this MlAssetsCreateModelInput.
        :rtype: str
        """
        return self._experiment_url

    @experiment_url.setter
    def experiment_url(self, experiment_url):
        """
        Sets the experiment_url of this MlAssetsCreateModelInput.
        The URL to the experiment which was used to create this model

        :param experiment_url: The experiment_url of this MlAssetsCreateModelInput.
        :type: str
        """
        self._experiment_url = experiment_url
