...
class TestWMLClientWithExperiment(unittest.TestCase):
    ...
    def test_17_store_trained_models(self):
    ...
    def test_18_delete_experiment_run(self):
    ...
    def test_23_get_models_details(self):
    ...
    def test_24_delete_models(self):
