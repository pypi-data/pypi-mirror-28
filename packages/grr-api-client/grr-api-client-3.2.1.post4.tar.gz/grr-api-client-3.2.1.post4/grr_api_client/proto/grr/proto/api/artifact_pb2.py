...
# source: grr/proto/api/artifact.proto
...
ApiListArtifactsArgs = _reflection.GeneratedProtocolMessageType('ApiListArtifactsArgs', (_message.Message,), dict(
  ...
  __module__ = 'grr.proto.api.artifact_pb2'
