...
class Products(DataBase):
  ...
  def get_size_products(self, version_id, is_available=None, is_processed=None, is_classified=None):
    query = {}
    query['version_id'] = version_id

    if is_available is not None:
      if is_available is False:
        query['$or'] = [{'is_available':{'$exists':False}}, {'is_available':None}, {'is_available':False}]
      else:
