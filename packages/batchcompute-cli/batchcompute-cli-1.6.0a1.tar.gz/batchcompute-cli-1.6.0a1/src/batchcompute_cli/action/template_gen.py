...
def replaceTemplate4GATK(dist):
    ...
    # main.sh3
    _replace_template(os.path.join(dist, 'gatk4-joint-discovery', 'main.sh'))
    # inputs3
    _replace_template(os.path.join(dist, 'gatk4-joint-discovery', 'src',
...
def _replace_template(p):
    ...
    if not bucket:
        raise Exception("This region do not support GATK")
