...
def forwards_func(apps, schema_editor):
    Product = apps.get_model('pcart_catalog', 'Product')
    ProductTranslation = apps.get_model('pcart_catalog', 'ProductTranslation')
...
def backwards_func(apps, schema_editor):
    ...
    for obj in Product.objects.all():
        translation = _get_translation(obj, ProductTranslation)
...
def _get_translation(object, ProductTranslation):
    translations = ProductTranslation.objects.filter(master_id=object.pk)
    try:
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('pcart_catalog', '0052_add_translations_to_product'),
    ]
