...
def auth():
    ...
    # # move controllers
    # shutil.copyfile(module_path+"/masonite-cli/snippets/auth/controllers/LoginController.py",
    #                 "app/http/controllers/LoginController.py")
    # shutil.copyfile(module_path+"/masonite-cli/snippets/auth/controllers/RegisterController.py",
    #                 "app/http/controllers/RegisterController.py")
    # shutil.copyfile(module_path+"/masonite-cli/snippets/auth/controllers/HomeController.py",
    #                 "app/http/controllers/HomeController.py")

    # # move templates
    # shutil.copytree(module_path + "/masonite-cli/snippets/auth/templates/auth",
