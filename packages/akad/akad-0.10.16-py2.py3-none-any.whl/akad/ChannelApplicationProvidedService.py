            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i637 in range(_size633):
                        _elem638 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for iter639 in self.success:
                oprot.writeString(iter639.encode('utf-8') if sys.version_info[0] == 2 else iter639)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.e is not None:
            oprot.writeFieldBegin('e', TType.STRUCT, 1)
...
class getSimpleChannelContacts_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i665 in range(_size661):
                        _elem666 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.ids.append(_elem666)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.ids is not None:
            ...
            oprot.writeListBegin(TType.STRING, len(self.ids))
            for iter667 in self.ids:
                oprot.writeString(iter667.encode('utf-8') if sys.version_info[0] == 2 else iter667)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class getUserIdentities_result(object):
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i679 in range(_size675):
                        _key680 = iprot.readI32()
                        _val681 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter682, viter683 in self.success.items():
                oprot.writeI32(kiter682)
                oprot.writeString(viter683.encode('utf-8') if sys.version_info[0] == 2 else viter683)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.e is not None:
            oprot.writeFieldBegin('e', TType.STRUCT, 1)
