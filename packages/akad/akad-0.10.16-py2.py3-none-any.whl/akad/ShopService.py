...
class getProductList_args(object):
            ...
            if fid == 2:
                if ftype == TType.LIST:
                    ...
                    for _i751 in range(_size747):
                        ...
                        self.productIdList.append(_elem752)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
    ...
    def write(self, oprot):
        ...
        if self.productIdList is not None:
            ...
            for iter753 in self.productIdList:
...
class getProductListWithCarrier_args(object):
            ...
            if fid == 2:
                if ftype == TType.LIST:
                    ...
                    for _i758 in range(_size754):
                        ...
                        self.productIdList.append(_elem759)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
    ...
    def write(self, oprot):
        ...
        if self.productIdList is not None:
            oprot.writeFieldBegin('productIdList', TType.LIST, 2)
            oprot.writeListBegin(TType.STRING, len(self.productIdList))
            for iter760 in self.productIdList:
