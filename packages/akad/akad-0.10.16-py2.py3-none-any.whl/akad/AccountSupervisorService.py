...
class notifyEmailConfirmationResult_args(object):
            ...
            if fid == 2:
                if ftype == TType.MAP:
                    ...
                    for _i392 in range(_size388):
                        ...
                        _val394 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.parameterMap[_key393] = _val394
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.parameterMap is not None:
            ...
            for kiter395, viter396 in self.parameterMap.items():
