...
class ApproveSquareMembersRequest(object):
            ...
            if fid == 2:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i327 in range(_size323):
                        ...
                        self.requestedMemberMids.append(_elem328)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.requestedMemberMids is not None:
            ...
            for iter329 in self.requestedMemberMids:
...
class CreateSquareChatRequest(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i334 in range(_size330):
                        ...
                        self.squareMemberMids.append(_elem335)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.squareMemberMids is not None:
            ...
            for iter336 in self.squareMemberMids:
...
class SquareEventNotifiedInviteIntoSquareChat(object):
    ...
    thrift_spec = (
        None,  # 0
        (1, TType.STRING, 'squareChatMid', 'UTF8', None, ),  # 1
        (2, TType.LIST, 'invitees', (TType.STRUCT, (SquareMember, SquareMember.thrift_spec), False), None, ),  # 2
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i341 in range(_size337):
                        _elem342 = SquareMember()
                        _elem342.read(iprot)
                        self.invitees.append(_elem342)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
...
class SquareEventNotifiedKickoutFromSquare(object):
    ...
    thrift_spec = (
        None,  # 0
        (1, TType.STRING, 'squareChatMid', 'UTF8', None, ),  # 1
        (2, TType.LIST, 'kickees', (TType.STRUCT, (SquareMember, SquareMember.thrift_spec), False), None, ),  # 2
    )
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i348 in range(_size344):
                        _elem349 = SquareMember()
                        _elem349.read(iprot)
                        self.kickees.append(_elem349)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
...
class UniversalNotificationServiceException(TException):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i355 in range(_size351):
                        ...
                        self.parameterMap[_key356] = _val357
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.parameterMap is not None:
            oprot.writeFieldBegin('parameterMap', TType.MAP, 3)
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.parameterMap))
            for kiter358, viter359 in self.parameterMap.items():
...
class UserAuthStatus(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i364 in range(_size360):
                        ...
                        self.registeredSnsIdTypes.append(_elem365)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.registeredSnsIdTypes is not None:
            ...
            for iter366 in self.registeredSnsIdTypes:
...
class VerificationSessionData(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i371 in range(_size367):
                        ...
                        self.availableVerificationMethods.append(_elem372)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.availableVerificationMethods is not None:
            ...
            for iter373 in self.availableVerificationMethods:
...
class GroupCall(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i378 in range(_size374):
                        ...
                        self.memberMids.append(_elem379)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
    ...
    def write(self, oprot):
        ...
        if self.memberMids is not None:
            ...
            for iter380 in self.memberMids:
