...
class commitSendMessagesToAll_args(object):
    ...
    def write(self, oprot):
        ...
        if self.requestIdList is not None:
            ...
            for iter410 in self.requestIdList:
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i415 in range(_size411):
                        _elem416 = SendBuddyMessageResult()
                        _elem416.read(iprot)
...
class commitSendMessagesToMids_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i422 in range(_size418):
                        ...
                        self.requestIdList.append(_elem423)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        ...
        if self.requestIdList is not None:
            oprot.writeFieldBegin('requestIdList', TType.LIST, 1)
            oprot.writeListBegin(TType.STRING, len(self.requestIdList))
            for iter430 in self.requestIdList:
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i436 in range(_size432):
                        _elem437 = SendBuddyMessageResult()
                        _elem437.read(iprot)
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i464 in range(_size460):
                        _elem465 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.mids.append(_elem465)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
...
class registerBuddy_args(object):
    ...
    def write(self, oprot):
        ...
        if self.settings is not None:
            ...
            for kiter474, viter475 in self.settings.items():
...
class updateBuddyAdminProfileAttribute_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i515 in range(_size511):
                        ...
                        self.attributes[_key516] = _val517
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.attributes is not None:
            ...
            for kiter518, viter519 in self.attributes.items():
...
class updateBuddyProfileAttributes_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i524 in range(_size520):
                        ...
                        _val526 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.attributes[_key525] = _val526
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.attributes is not None:
            oprot.writeFieldBegin('attributes', TType.MAP, 2)
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.attributes))
            for kiter527, viter528 in self.attributes.items():
                oprot.writeString(kiter527.encode('utf-8') if sys.version_info[0] == 2 else kiter527)
                oprot.writeString(viter528.encode('utf-8') if sys.version_info[0] == 2 else viter528)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class updateBuddyProfileAttributesAsync_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i533 in range(_size529):
                        ...
                        self.attributes[_key534] = _val535
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.attributes is not None:
            oprot.writeFieldBegin('attributes', TType.MAP, 2)
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.attributes))
            for kiter536, viter537 in self.attributes.items():
...
class updateBuddySettings_args(object):
    ...
    def write(self, oprot):
        ...
        if self.settings is not None:
            ...
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.settings))
            for kiter545, viter546 in self.settings.items():
