            ...
            if fid == 2:
                if ftype == TType.LIST:
                    ...
                    for _i723 in range(_size719):
                        _elem724 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.chatIds.append(_elem724)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
