            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i695 in range(_size691):
                        _elem696 = ChannelNotificationSetting()
                        _elem696.read(iprot)
...
class getFriendChannelMatrices_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i702 in range(_size698):
                        ...
                        self.channelIds.append(_elem703)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.channelIds is not None:
            ...
            for iter704 in self.channelIds:
...
class issueRequestTokenWithAuthScheme_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i709 in range(_size705):
                        ...
                        self.authScheme.append(_elem710)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
    ...
    def write(self, oprot):
        ...
        if self.authScheme is not None:
            ...
            for iter711 in self.authScheme:
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i716 in range(_size712):
                        _elem717 = ChannelNotificationSetting()
                        _elem717.read(iprot)
                        self.setting.append(_elem717)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
