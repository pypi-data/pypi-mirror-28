...
setup(
    ...
    license='',
    url='https://github.com/alexandreMartinEcl/test_solveengine',
    download_url='https://github.com/alexandreMartinEcl/test_solveengine/archive/0.3.tar.gz',
