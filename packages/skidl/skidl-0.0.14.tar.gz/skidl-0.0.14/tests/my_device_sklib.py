...
my_device = SchLib(tool=SKIDL).add_parts(*[
        ...
        Part(name='Antenna_Chip',dest=TEMPLATE,tool=SKIDL,keywords='antenna',description='Ceramic Chip Antenna symbol with pin for PCB trace',ref_prefix='AE',num_units=1,do_erc=True,pins=[
            Pin(num='1',name='FEED',do_erc=True),
            Pin(num='2',name='PCB_Trace',func=Pin.PASSIVE,do_erc=True)]),
        ...
        Part(name='Crystal_GND23_Small',dest=TEMPLATE,tool=SKIDL,keywords='quartz ceramic resonator oscillator',description='Four pin crystal, two ground/package pins (pin2 and 3) small symbol',ref_prefix='Y',num_units=1,fplist=['Crystal*'],do_erc=True,pins=[
            Pin(num='1',name='1',func=Pin.PASSIVE,do_erc=True),
            Pin(num='2',name='2',func=Pin.PASSIVE,do_erc=True),
            Pin(num='3',name='3',func=Pin.PASSIVE,do_erc=True),
            Pin(num='4',name='4',func=Pin.PASSIVE,do_erc=True)]),
        Part(name='Crystal_GND24',dest=TEMPLATE,tool=SKIDL,keywords='quartz ceramic resonator oscillator',description='Four pin crystal (GND on pins 2 and 4), e.g. in SMD package',ref_prefix='Y',num_units=1,fplist=['Crystal*'],do_erc=True,pins=[
            ...
            Pin(num='3',name='3',func=Pin.PASSIVE,do_erc=True),
            Pin(num='4',name='4',func=Pin.PASSIVE,do_erc=True)]),
        Part(name='Crystal_GND24_Small',dest=TEMPLATE,tool=SKIDL,keywords='quartz ceramic resonator oscillator',description='Four pin crystal, two ground/package pins (pin2 and 4) small symbol',ref_prefix='Y',num_units=1,fplist=['Crystal*'],do_erc=True,pins=[
            Pin(num='1',name='1',func=Pin.PASSIVE,do_erc=True),
            Pin(num='2',name='2',func=Pin.PASSIVE,do_erc=True),
            Pin(num='3',name='3',func=Pin.PASSIVE,do_erc=True),
            Pin(num='4',name='4',func=Pin.PASSIVE,do_erc=True)]),
        Part(name='Crystal_GND2_Small',dest=TEMPLATE,tool=SKIDL,keywords='quartz ceramic resonator oscillator',description='Three pin crystal, one ground/package pins (pin2) small symbol',ref_prefix='Y',num_units=1,fplist=['Crystal*'],do_erc=True,pins=[
            Pin(num='1',name='1',func=Pin.PASSIVE,do_erc=True),
            Pin(num='2',name='2',func=Pin.PASSIVE,do_erc=True),
            Pin(num='3',name='3',func=Pin.PASSIVE,do_erc=True)]),
        Part(name='Crystal_GND3',dest=TEMPLATE,tool=SKIDL,keywords='quartz ceramic resonator oscillator',description='Three pin crystal (GND on pin 3), e.g. in SMD package',ref_prefix='Y',num_units=1,fplist=['Crystal*'],do_erc=True,pins=[
            ...
            Pin(num='2',name='2',func=Pin.PASSIVE,do_erc=True),
            Pin(num='3',name='3',func=Pin.PASSIVE,do_erc=True)]),
        Part(name='Crystal_GND3_Small',dest=TEMPLATE,tool=SKIDL,keywords='quartz ceramic resonator oscillator',description='Three pin crystal, one ground/package pins (pin3) small symbol',ref_prefix='Y',num_units=1,fplist=['Crystal*'],do_erc=True,pins=[
            Pin(num='1',name='1',func=Pin.PASSIVE,do_erc=True),
            Pin(num='2',name='2',func=Pin.PASSIVE,do_erc=True),
            Pin(num='3',name='3',func=Pin.PASSIVE,do_erc=True)]),
        ...
        Part(name='D_Shockley',dest=TEMPLATE,tool=SKIDL,keywords='Shockley diode',description='Shockley Diode (PNPN Diode)',ref_prefix='D',num_units=1,fplist=['TO-???*', '*SingleDiode', '*_Diode_*', '*SingleDiode*', 'D_*'],do_erc=True,pins=[
            Pin(num='1',name='K',func=Pin.PASSIVE,do_erc=True),
            Pin(num='2',name='A',func=Pin.PASSIVE,do_erc=True)]),
        Part(name='D_SiPM',dest=TEMPLATE,tool=SKIDL,keywords='SiPM MPPC SPAD',description='Silicon photomultiplier for counting of individual photons',ref_prefix='D',num_units=1,fplist=['MPPC*'],do_erc=True,pins=[
            Pin(num='1',name='K',func=Pin.PASSIVE,do_erc=True),
            Pin(num='2',name='A',func=Pin.PASSIVE,do_erc=True)]),
        ...
        Part(name='LED_ALT',dest=TEMPLATE,tool=SKIDL,keywords='led diode',description='LED generic, alternativ symbol',ref_prefix='D',num_units=1,fplist=['LED*'],do_erc=True,pins=[
            Pin(num='1',name='K',func=Pin.PASSIVE,do_erc=True),
            Pin(num='2',name='A',func=Pin.PASSIVE,do_erc=True)]),
        Part(name='LED_ARGB',dest=TEMPLATE,tool=SKIDL,keywords='led rgb diode',description='LED RGB, common anode (pin 1)',ref_prefix='D',num_units=1,fplist=['LED*'],do_erc=True,pins=[
            Pin(num='1',name='A',func=Pin.PASSIVE,do_erc=True),
        ...
        Part(name='LED_BGRA',dest=TEMPLATE,tool=SKIDL,keywords='led rgb diode',description='LED RGB, common anode',ref_prefix='D',num_units=1,fplist=['LED*'],do_erc=True,pins=[
            Pin(num='1',name='BK',func=Pin.PASSIVE,do_erc=True),
            Pin(num='2',name='GK',func=Pin.PASSIVE,do_erc=True),
            Pin(num='3',name='RK',func=Pin.PASSIVE,do_erc=True),
            Pin(num='4',name='A',func=Pin.PASSIVE,do_erc=True)]),
        Part(name='LED_CRGB',dest=TEMPLATE,tool=SKIDL,keywords='led rgb diode',description='LED RGB, Common Cathode',ref_prefix='D',num_units=1,fplist=['LED*'],do_erc=True,pins=[
            Pin(num='1',name='K',func=Pin.PASSIVE,do_erc=True),
        ...
        Part(name='LED_Dual_2pin',dest=TEMPLATE,tool=SKIDL,keywords='led diode bicolor dual',description='LED dual, 2pin version',ref_prefix='D',num_units=1,fplist=['LED*'],do_erc=True,pins=[
            Pin(num='1',name='KA',do_erc=True),
            Pin(num='2',name='AK',do_erc=True)]),
        Part(name='LED_Dual_AAC',dest=TEMPLATE,tool=SKIDL,keywords='led diode bicolor dual',description='LED dual, common cathode',ref_prefix='D',num_units=1,fplist=['LED*'],do_erc=True,pins=[
            Pin(num='1',name='A1',do_erc=True),
            Pin(num='2',name='A2',do_erc=True),
            Pin(num='3',name='K',do_erc=True)]),
        Part(name='LED_Dual_AACC',dest=TEMPLATE,tool=SKIDL,keywords='led diode bicolor dual',description='LED dual, 4-pin',ref_prefix='D',num_units=1,fplist=['LED*'],do_erc=True,pins=[
            Pin(num='1',name='A1',do_erc=True),
            Pin(num='2',name='A2',do_erc=True),
            Pin(num='3',name='K1',do_erc=True),
            Pin(num='4',name='K2',do_erc=True)]),
        Part(name='LED_Dual_ACA',dest=TEMPLATE,tool=SKIDL,keywords='led diode bicolor dual',description='LED dual, common cathode',ref_prefix='D',num_units=1,fplist=['LED*'],do_erc=True,pins=[
            Pin(num='1',name='A1',do_erc=True),
            Pin(num='2',name='K',do_erc=True),
            Pin(num='3',name='A2',do_erc=True)]),
        Part(name='LED_Dual_ACAC',dest=TEMPLATE,tool=SKIDL,keywords='led diode bicolor dual',description='LED dual, 4-pin',ref_prefix='D',num_units=1,fplist=['LED*'],do_erc=True,pins=[
            Pin(num='1',name='A1',do_erc=True),
            Pin(num='2',name='K1',do_erc=True),
            Pin(num='3',name='A2',do_erc=True),
            Pin(num='4',name='K2',do_erc=True)]),
        Part(name='LED_Dual_CAC',dest=TEMPLATE,tool=SKIDL,keywords='led diode bicolor dual',description='LED dual, common anode',ref_prefix='D',num_units=1,fplist=['LED*'],do_erc=True,pins=[
            Pin(num='1',name='K1',do_erc=True),
            Pin(num='2',name='A',do_erc=True),
            Pin(num='3',name='K2',do_erc=True)]),
        Part(name='LED_Dual_CCA',dest=TEMPLATE,tool=SKIDL,keywords='led diode bicolor dual',description='LED dual, common anode',ref_prefix='D',num_units=1,fplist=['LED*'],do_erc=True,pins=[
            Pin(num='1',name='K1',do_erc=True),
        ...
        Part(name='LED_RABG',dest=TEMPLATE,tool=SKIDL,keywords='led rgb diode',description='LED RGB, common anode',ref_prefix='D',num_units=1,fplist=['LED*'],do_erc=True,pins=[
        ...
        Part(name='LED_RAGB',dest=TEMPLATE,tool=SKIDL,keywords='led rgb diode',description='LED RGB, common anode',ref_prefix='D',num_units=1,fplist=['LED*'],do_erc=True,pins=[
            Pin(num='1',name='RK',func=Pin.PASSIVE,do_erc=True),
            Pin(num='2',name='A',func=Pin.PASSIVE,do_erc=True),
            Pin(num='3',name='GK',func=Pin.PASSIVE,do_erc=True),
            Pin(num='4',name='BK',func=Pin.PASSIVE,do_erc=True)]),
        Part(name='LED_RCBG',dest=TEMPLATE,tool=SKIDL,keywords='led rgb diode',description='LED RGB, Common Cathode',ref_prefix='D',num_units=1,fplist=['LED*'],do_erc=True,pins=[
        ...
        Part(name='LED_RCGB',dest=TEMPLATE,tool=SKIDL,keywords='led rgb diode',description='LED RGB, Common Cathode',ref_prefix='D',num_units=1,fplist=['LED*'],do_erc=True,pins=[
            Pin(num='1',name='RA',func=Pin.PASSIVE,do_erc=True),
            Pin(num='2',name='K',func=Pin.PASSIVE,do_erc=True),
            Pin(num='3',name='GA',func=Pin.PASSIVE,do_erc=True),
            Pin(num='4',name='BA',func=Pin.PASSIVE,do_erc=True)]),
        Part(name='LED_RGB',dest=TEMPLATE,tool=SKIDL,keywords='led rgb diode',description='LED RGB 6 pins',ref_prefix='D',num_units=1,fplist=['LED*'],do_erc=True,pins=[
            Pin(num='1',name='RK',func=Pin.PASSIVE,do_erc=True),
            Pin(num='2',name='GK',func=Pin.PASSIVE,do_erc=True),
            Pin(num='3',name='BK',func=Pin.PASSIVE,do_erc=True),
            Pin(num='4',name='BA',func=Pin.PASSIVE,do_erc=True),
        ...
        Part(name='LED_RGB_EP',dest=TEMPLATE,tool=SKIDL,keywords='led rgb diode',description='LED RGB 6 pins, exposed pad',ref_prefix='D',num_units=1,fplist=['LED*'],do_erc=True,pins=[
            Pin(num='1',name='RK',func=Pin.PASSIVE,do_erc=True),
            Pin(num='2',name='GK',func=Pin.PASSIVE,do_erc=True),
            Pin(num='3',name='BK',func=Pin.PASSIVE,do_erc=True),
            Pin(num='4',name='BA',func=Pin.PASSIVE,do_erc=True),
        ...
        Part(name='LED_Series_PAD',dest=TEMPLATE,tool=SKIDL,keywords='led diode pad',description='LED with pad',ref_prefix='D',num_units=1,fplist=['LED*'],do_erc=True,pins=[
            ...
            Pin(num='2',name='A',func=Pin.PASSIVE,do_erc=True),
            Pin(num='3',name='PAD',func=Pin.PASSIVE,do_erc=True)]),
        Part(name='LED_Small',dest=TEMPLATE,tool=SKIDL,keywords='led diode light-emitting-diode',description='LED, small symbol',ref_prefix='D',num_units=1,fplist=['LED*'],do_erc=True,pins=[
            Pin(num='1',name='K',func=Pin.PASSIVE,do_erc=True),
            Pin(num='2',name='A',func=Pin.PASSIVE,do_erc=True)]),
        Part(name='LED_Small_ALT',dest=TEMPLATE,tool=SKIDL,keywords='led diode light-emitting-diode',description='LED, small symbol, alternativ symbol',ref_prefix='D',num_units=1,fplist=['LED*'],do_erc=True,pins=[
            Pin(num='1',name='K',func=Pin.PASSIVE,do_erc=True),
            Pin(num='2',name='A',func=Pin.PASSIVE,do_erc=True)]),
        ...
        Part(name='Microphone_Crystal',dest=TEMPLATE,tool=SKIDL,keywords='Microphone Ultrasound crystal',description='Ultrasound receiver',ref_prefix='MK',num_units=1,do_erc=True,aliases=['Microphone_Ultrasound'],pins=[
            Pin(num='1',name='-',func=Pin.PASSIVE,do_erc=True),
            Pin(num='2',name='+',func=Pin.PASSIVE,do_erc=True)]),
        Part(name='Net-Tie_2',dest=TEMPLATE,tool=SKIDL,keywords='net tie short',description='Net Tie, 2 pins',ref_prefix='NT',num_units=1,fplist=['Net*Tie*'],do_erc=True,pins=[
            Pin(num='1',name='1',func=Pin.PASSIVE,do_erc=True),
            Pin(num='2',name='2',func=Pin.PASSIVE,do_erc=True)]),
        Part(name='Net-Tie_3',dest=TEMPLATE,tool=SKIDL,keywords='net tie short',description='Net Tie, 3 pins',ref_prefix='NT',num_units=1,fplist=['Net*Tie*'],do_erc=True,pins=[
            Pin(num='1',name='1',func=Pin.PASSIVE,do_erc=True),
            Pin(num='2',name='2',func=Pin.PASSIVE,do_erc=True),
            Pin(num='3',name='3',func=Pin.PASSIVE,do_erc=True)]),
        Part(name='Net-Tie_3_Tee',dest=TEMPLATE,tool=SKIDL,keywords='net tie short',description='Net Tie, 3 pins, tee',ref_prefix='NT',num_units=1,fplist=['Net*Tie*'],do_erc=True,pins=[
            Pin(num='1',name='1',func=Pin.PASSIVE,do_erc=True),
            Pin(num='2',name='2',func=Pin.PASSIVE,do_erc=True),
            Pin(num='3',name='3',func=Pin.PASSIVE,do_erc=True)]),
        Part(name='Net-Tie_4',dest=TEMPLATE,tool=SKIDL,keywords='net tie short',description='Net Tie, 4 pins',ref_prefix='NT',num_units=1,fplist=['Net*Tie*'],do_erc=True,pins=[
            Pin(num='1',name='1',func=Pin.PASSIVE,do_erc=True),
            Pin(num='2',name='2',func=Pin.PASSIVE,do_erc=True),
            Pin(num='3',name='3',func=Pin.PASSIVE,do_erc=True),
            Pin(num='4',name='4',func=Pin.PASSIVE,do_erc=True)]),
        Part(name='Net-Tie_4_Cross',dest=TEMPLATE,tool=SKIDL,keywords='net tie short',description='Net Tie, 4 pins, cross',ref_prefix='NT',num_units=1,fplist=['Net*Tie*'],do_erc=True,pins=[
            Pin(num='1',name='1',func=Pin.PASSIVE,do_erc=True),
            Pin(num='2',name='2',func=Pin.PASSIVE,do_erc=True),
            Pin(num='3',name='3',func=Pin.PASSIVE,do_erc=True),
            Pin(num='4',name='4',func=Pin.PASSIVE,do_erc=True)]),
        Part(name='Ohmmeter',dest=TEMPLATE,tool=SKIDL,keywords='Ohmmeter',description='Ohmmeter, measures resistance',ref_prefix='MES',num_units=1,do_erc=True,pins=[
            Pin(num='1',name='-',func=Pin.PASSIVE,do_erc=True),
            Pin(num='2',name='+',func=Pin.PASSIVE,do_erc=True)]),
        Part(name='Opamp_Dual_Generic',dest=TEMPLATE,tool=SKIDL,keywords='dual opamp',description='Dual Opamp, SOIC-8/DIP-8/SSOP-8/TO-99',ref_prefix='U',num_units=3,fplist=['SOIC*3.9x4.9mm*Pitch1.27mm*', 'DIP*W7.62mm*', 'MSOP*3x3mm*Pitch0.65mm*', 'SSOP*2.95x2.8mm*Pitch0.65mm*', 'TSSOP*3x3mm*Pitch0.65mm*', 'VSSOP*Pitch0.5mm*', 'TO?99*'],do_erc=True,pins=[
        ...
        Part(name='Opamp_Quad_Generic',dest=TEMPLATE,tool=SKIDL,keywords='quad opamp',description='Quad Opamp, SOIC-14/DIP-14/SSOP-14',ref_prefix='U',num_units=5,fplist=['SOIC*3.9x8.7mm*Pitch1.27mm*', 'DIP*W7.62mm*', 'TSSOP*4.4x5mm*Pitch0.65mm*', 'SSOP*5.3x6.2mm*Pitch0.65mm*'],do_erc=True,pins=[
            Pin(num='1',name='~',func=Pin.OUTPUT,do_erc=True),
            Pin(num='2',name='-',do_erc=True),
            Pin(num='3',name='+',do_erc=True),
            Pin(num='5',name='+',do_erc=True),
        ...
        Part(name='Oscilloscope',dest=TEMPLATE,tool=SKIDL,keywords='Oscilloscope',description='Oscilloscope',ref_prefix='MES',num_units=1,do_erc=True,pins=[
            Pin(num='1',name='-',func=Pin.PASSIVE,do_erc=True),
            Pin(num='2',name='+',func=Pin.PASSIVE,do_erc=True)]),
        Part(name='POT',dest=TEMPLATE,tool=SKIDL,keywords='resistor variable',description='Potentiometer',ref_prefix='RV',num_units=1,fplist=['Potentiometer*'],do_erc=True,pins=[
            Pin(num='1',name='1',func=Pin.PASSIVE,do_erc=True),
            Pin(num='2',name='2',func=Pin.PASSIVE,do_erc=True),
            Pin(num='3',name='3',func=Pin.PASSIVE,do_erc=True)]),
        Part(name='POT_Dual',dest=TEMPLATE,tool=SKIDL,keywords='resistor variable',description='Dual Potentiometer',ref_prefix='RV',num_units=1,fplist=['Potentiometer*'],do_erc=True,pins=[
            Pin(num='1',name='1',func=Pin.PASSIVE,do_erc=True),
            Pin(num='2',name='2',func=Pin.PASSIVE,do_erc=True),
            Pin(num='3',name='3',func=Pin.PASSIVE,do_erc=True),
            Pin(num='4',name='4',func=Pin.PASSIVE,do_erc=True),
        ...
        Part(name='POT_Dual_Separate',dest=TEMPLATE,tool=SKIDL,keywords='resistor variable',description='Dual Potentiometer, separate units',ref_prefix='RV',num_units=2,fplist=['Potentiometer*'],do_erc=True,pins=[
            Pin(num='1',name='1',func=Pin.PASSIVE,do_erc=True),
            Pin(num='2',name='2',func=Pin.PASSIVE,do_erc=True),
            Pin(num='3',name='3',func=Pin.PASSIVE,do_erc=True),
            Pin(num='4',name='4',func=Pin.PASSIVE,do_erc=True),
            Pin(num='5',name='5',func=Pin.PASSIVE,do_erc=True),
            Pin(num='6',name='6',func=Pin.PASSIVE,do_erc=True)]),
        Part(name='POT_TRIM',dest=TEMPLATE,tool=SKIDL,keywords='resistor variable trimpot trimmer',description='Trim-Potentiometer',ref_prefix='RV',num_units=1,fplist=['Potentiometer*'],do_erc=True,pins=[
            Pin(num='1',name='1',func=Pin.PASSIVE,do_erc=True),
            Pin(num='2',name='2',func=Pin.PASSIVE,do_erc=True),
            Pin(num='3',name='3',func=Pin.PASSIVE,do_erc=True)]),
        ...
        Part(name='Polyfuse_Small',dest=TEMPLATE,tool=SKIDL,keywords='resettable fuse PTC PPTC polyfuse polyswitch',description='resettable fuse, polymeric positive temperature coefficient (PPTC), small symbol',ref_prefix='F',num_units=1,fplist=['*polyfuse*', '*PTC*'],do_erc=True,pins=[
            Pin(num='1',name='~',func=Pin.PASSIVE,do_erc=True),
            Pin(num='2',name='~',func=Pin.PASSIVE,do_erc=True)]),
        Part(name='Q_DUAL_NPN_C2C1E1E2',dest=TEMPLATE,tool=SKIDL,keywords='Transistor Double NPN',description='Double NPN Transistors, Current mirror configuration',ref_prefix='Q',num_units=1,fplist=['SOT?143*'],do_erc=True,pins=[
        ...
        Part(name='Q_DUAL_NPN_PNP_E1B1C2E2B2C1',dest=TEMPLATE,tool=SKIDL,keywords='NPN/PNP Transistor',description='Dual NPN/PNP Transistor, 6-pin package',ref_prefix='Q',num_units=2,fplist=['SC?70*', 'SC?88*', 'SOT?363*'],do_erc=True,pins=[
            ...
            Pin(num='4',name='E2',func=Pin.PASSIVE,do_erc=True),
            Pin(num='5',name='B2',do_erc=True)]),
        Part(name='Q_DUAL_PNP_C2C1E1E2',dest=TEMPLATE,tool=SKIDL,keywords='Transistor Double PNP',description='Double PNP Transistors, Current mirror configuration',ref_prefix='Q',num_units=1,fplist=['SOT?143*'],do_erc=True,pins=[
            Pin(num='1',name='C2',func=Pin.PASSIVE,do_erc=True),
            Pin(num='2',name='C1',func=Pin.PASSIVE,do_erc=True),
            Pin(num='3',name='E1',func=Pin.PASSIVE,do_erc=True),
            Pin(num='4',name='E2',func=Pin.PASSIVE,do_erc=True)]),
        Part(name='Q_DUAL_PNP_PNP_C1B1B2C2E2E1',dest=TEMPLATE,tool=SKIDL,keywords='PNP/PNP Transistor',description='Dual PNP/PNP Transistor, 6-pin package',ref_prefix='Q',num_units=2,fplist=['SOT*'],do_erc=True,pins=[
            Pin(num='1',name='C1',func=Pin.PASSIVE,do_erc=True),
            Pin(num='2',name='B1',do_erc=True),
            Pin(num='6',name='E1',func=Pin.PASSIVE,do_erc=True),
            Pin(num='3',name='B2',do_erc=True),
            Pin(num='4',name='C2',func=Pin.PASSIVE,do_erc=True),
            Pin(num='5',name='E2',func=Pin.PASSIVE,do_erc=True)]),
        ...
        Part(name='Q_Photo_NPN_EBC',dest=TEMPLATE,tool=SKIDL,keywords='npn phototransistor',description='Phototransistor NPN, 3-pin with base pin (E=1, B=2, C=3)',ref_prefix='Q',num_units=1,do_erc=True,pins=[
            ...
            Pin(num='2',name='B',do_erc=True),
            Pin(num='3',name='C',func=Pin.PASSIVE,do_erc=True)]),
        Part(name='Q_Photo_NPN_EC',dest=TEMPLATE,tool=SKIDL,keywords='NPN phototransistor',description='Phototransistor NPN, 2-pin (E=1, C=2)',ref_prefix='Q',num_units=1,do_erc=True,pins=[
            Pin(num='1',name='E',func=Pin.PASSIVE,do_erc=True),
            Pin(num='2',name='C',func=Pin.PASSIVE,do_erc=True)]),
