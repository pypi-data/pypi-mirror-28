...
from offcrawler.downloader import get_today_covers, save_product_images
...
@app.route('product/setImages')
def set_product_images():
    data = request.get_json()
    save_product_images(data["product_id"], data["cover"], data["image_urls"])
    return make_response(json.dumps(data))
