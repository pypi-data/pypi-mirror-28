...
desc = '''
    %s
    $ fladm upload username:password@domain [local filename] [dest filename]
''' % summary
...
def get_usage_examples():
    return [
        '$ fladm upload exem:1234@flamingo-exem.org workflow.xml /flamingo/oozie/test-wf/workflow.xml'
    ]
