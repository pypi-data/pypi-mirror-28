...
import sys
import argparse
from fl3.auth import Auth
from fl3.hdfs import File
from fl3.oozie import OozieClient
...
def oozie_run(args):
    print 'oozie... type=%s xml_path=%s config=%s base_url=%s' % (args.type, args.xml_path, args.config, args.base_url)
    ...
    oozie = OozieClient('http://master2.exem.oss:11000/oozie')
