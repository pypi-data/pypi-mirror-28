...
class Mail:
    """An object encapsulating a mail server including SMTP, IMAP and DKIM.

    Note that mail delivery is via SMTP, but mail forwarding is only via authenticated SMTPS."""
