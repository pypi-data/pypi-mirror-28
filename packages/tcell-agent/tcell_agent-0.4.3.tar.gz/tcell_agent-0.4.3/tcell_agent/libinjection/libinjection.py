...
def is_xss(s):
    return _libinjection.is_xss(s)
is_xss = _libinjection.is_xss

_libinjection.FLAG_NONE_swigconstant(_libinjection)
FLAG_NONE = _libinjection.FLAG_NONE

_libinjection.FLAG_QUOTE_NONE_swigconstant(_libinjection)
FLAG_QUOTE_NONE = _libinjection.FLAG_QUOTE_NONE

_libinjection.FLAG_QUOTE_SINGLE_swigconstant(_libinjection)
FLAG_QUOTE_SINGLE = _libinjection.FLAG_QUOTE_SINGLE

_libinjection.FLAG_QUOTE_DOUBLE_swigconstant(_libinjection)
FLAG_QUOTE_DOUBLE = _libinjection.FLAG_QUOTE_DOUBLE

_libinjection.FLAG_SQL_ANSI_swigconstant(_libinjection)
FLAG_SQL_ANSI = _libinjection.FLAG_SQL_ANSI

_libinjection.FLAG_SQL_MYSQL_swigconstant(_libinjection)
FLAG_SQL_MYSQL = _libinjection.FLAG_SQL_MYSQL

_libinjection.LOOKUP_WORD_swigconstant(_libinjection)
LOOKUP_WORD = _libinjection.LOOKUP_WORD

_libinjection.LOOKUP_TYPE_swigconstant(_libinjection)
LOOKUP_TYPE = _libinjection.LOOKUP_TYPE

_libinjection.LOOKUP_OPERATOR_swigconstant(_libinjection)
LOOKUP_OPERATOR = _libinjection.LOOKUP_OPERATOR

_libinjection.LOOKUP_FINGERPRINT_swigconstant(_libinjection)
...
def is_sqli_state(sql_state):
    return _libinjection.is_sqli_state(sql_state)
is_sqli_state = _libinjection.is_sqli_state

def sqli_callback(sql_state, fn, userdata):
    return _libinjection.sqli_callback(sql_state, fn, userdata)
...
def is_sqli(s):
    return _libinjection.is_sqli(s)
