...
class TCellInstrumentationContext(object):
    ...
    def set_remote_addr(self, raw_ip_address):
        self.raw_remote_addr = raw_ip_address
        self.remote_addr = raw_ip_address
        if CONFIGURATION.hipaa_safe_mode:
            self.remote_addr = "hmac:{ip}".format(ip=raw_ip_address)
