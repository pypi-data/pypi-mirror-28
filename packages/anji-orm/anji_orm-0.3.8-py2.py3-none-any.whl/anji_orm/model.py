...
class Model(object, metaclass=ModelMetaclass):  # pylint: disable=too-many-public-methods
    ...
    @overload
    @classmethod
    def count(cls, query: QueryStatement = None):
        pass

    @overload
    @classmethod
    def count(cls, query: QueryStatementsCollection = None):  # pylint: disable=function-redefined
        pass
    ...
    def count(cls, query=None) -> R.RqlQuery:  # pylint: disable=function-redefined
        ...
        return RethinkDBQueryParser.build_query(cls, query).count()  # type: ignore
