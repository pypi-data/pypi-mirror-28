...
from .utils import NotYetImplementException, ensure_dict
...
def fetch(rethink_dict: Dict[str, Any]):  # pylint: disable=function-redefined
    if '__python_info' not in rethink_dict:
...
class Model(object, metaclass=ModelMetaclass):  # pylint: disable=too-many-public-methods
    ...
    @overload
    @classmethod
    def count(cls, query: QueryStatement = None) -> R.RqlQuery:
        pass   # pragma: no cover

    @overload
    @classmethod
    def count(cls, query: QueryStatementsCollection = None) -> R.RqlQuery:  # pylint: disable=function-redefined
        pass   # pragma: no cover

    @classmethod
    def count(cls, query=None) -> R.RqlQuery:  # pylint: disable=function-redefined
        if query is None:
            return cls.all().count()
        return cls.db_query(query).count()  # type: ignore

    @overload
    @classmethod
    def sample(cls, count: int, query: QueryStatement = None) -> R.RqlQuery:
        pass   # pragma: no cover

    @overload
    @classmethod
    def sample(cls, count: int, query: QueryStatementsCollection = None) -> R.RqlQuery:  # pylint: disable=function-redefined
        pass   # pragma: no cover

    @classmethod
    def sample(cls, count: int, query=None) -> R.RqlQuery:  # pylint: disable=function-redefined
        if query is None:
            return cls.all().sample(count)
        return cls.db_query(query).sample(count)  # type: ignore
    ...
    def build_similarity_query(self) -> QueryStatementsCollection:  # pylint: disable=no-self-use
        raise NotYetImplementException("Hehehe, sad")
    ...
    @classmethod
    def _process_driver_response(cls, result):
    ...
    def execute(cls, db_query: R.RqlQuery):
        ...
        if isinstance(result, R.net.DefaultCursor):
            return list(filter(lambda x: x is not None, (fetch(obj_data) for obj_data in result)))
        return cls._process_driver_response(result)
    ...
    @overload
    @classmethod
    def db_query(cls, query: QueryStatement) -> R.RqlQuery:
        pass   # pragma: no cover

    @overload
    @classmethod
    def db_query(cls, query: QueryStatementsCollection) -> R.RqlQuery:  # pylint: disable=function-redefined
        pass   # pragma: no cover

    @classmethod
    def db_query(cls, query) -> R.RqlQuery:  # pylint: disable=function-redefined
        return RethinkDBQueryParser.build_query(cls, query)  # type: ignore
    ...
    @overload
    @classmethod
    async def async_query(cls, query: QueryStatement):
        pass   # pragma: no cover

    @overload
    @classmethod
    async def async_query(cls, query: QueryStatementsCollection):  # pylint: disable=function-redefined
        pass   # pragma: no cover

    @classmethod
    async def async_query(cls, query):  # pylint: disable=function-redefined
        builded_query = RethinkDBQueryParser.build_query(cls, query)
        return await cls.async_execute(builded_query)
