...
class InputMediaInvoice(TLObject):
    ...
    def to_dict(self, recursive=True):
        return {
            ...
            'provider': self.provider,
            'provider_data': (None if self.provider_data is None else self.provider_data.to_dict()) if recursive else self.provider_data,
            'start_param': self.start_param,
        }
...
class InputPaymentCredentialsAndroidPay(TLObject):
    ...
    def to_dict(self, recursive=True):
        return {
            'payment_token': (None if self.payment_token is None else self.payment_token.to_dict()) if recursive else self.payment_token,
...
class InputPaymentCredentialsApplePay(TLObject):
    ...
    def to_dict(self, recursive=True):
        return {
            'payment_data': (None if self.payment_data is None else self.payment_data.to_dict()) if recursive else self.payment_data,
        }
...
class MessageFwdHeader(TLObject):
    ...
    def __init__(self, date, from_id=None, channel_id=None, channel_post=None, post_author=None, saved_from_peer=None, saved_from_msg_id=None):
        ...
        :param str | None post_author:
        :param TLObject | None saved_from_peer:
    ...
    def to_dict(self, recursive=True):
        return {
            ...
            'post_author': self.post_author,
            'saved_from_peer': (None if self.saved_from_peer is None else self.saved_from_peer.to_dict()) if recursive else self.saved_from_peer,
