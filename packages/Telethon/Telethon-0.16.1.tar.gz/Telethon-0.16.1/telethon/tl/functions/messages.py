...
class SendMultiMediaRequest(TLObject):
    ...
    def __init__(self, peer, multi_media, silent=None, background=None, clear_draft=None, reply_to_msg_id=None):
        ...
        :param TLObject peer:
        :param int | None reply_to_msg_id:
        :param list[TLObject] multi_media:
    ...
    def to_dict(self, recursive=True):
        return {
            ...
            'peer': (None if self.peer is None else self.peer.to_dict()) if recursive else self.peer,
            'reply_to_msg_id': self.reply_to_msg_id,
            'multi_media': ([] if self.multi_media is None else [None if x is None else x.to_dict() for x in self.multi_media]) if recursive else self.multi_media,
        }
