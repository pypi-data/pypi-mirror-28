...
buf.push("<div class=\"isso-postbox\"><img class=\"avatar\"/><div class=\"form-wrapper\"><div class=\"textarea-wrapper\"><div contenteditable=\"true\" class=\"textarea placeholder\">" + (jade.escape(null == (jade_interp = i18n('postbox-text')) ? "" : jade_interp)) + "</div></div><section class=\"auth-section\"><div class=\"auth-not-loggedin\"><div class=\"auth-login-optional\"><p class=\"input-wrapper\"><input type=\"text\" name=\"author\"" + (jade.attr("placeholder", i18n('postbox-author'), true, false)) + (jade.attr("value", author !== null ? '' + (author) + '' : '', true, false)) + "/></p><p class=\"input-wrapper\"><input type=\"email\" name=\"email\"" + (jade.attr("placeholder", i18n('postbox-email'), true, false)) + (jade.attr("value", email != null ? '' + (email) + '' : '', true, false)) + "/></p><p class=\"input-wrapper\"><input type=\"text\" name=\"website\"" + (jade.attr("placeholder", i18n('postbox-website'), true, false)) + (jade.attr("value", website != null ? '' + (website) + '' : '', true, false)) + "/></p><p class=\"login-separator\">" + (jade.escape((jade_interp = i18n('auth-login')) == null ? '' : jade_interp)) + "</p></div><div class=\"auth-login-mandatory\"><p class=\"login-separator\">" + (jade.escape((jade_interp = i18n('auth-must-login')) == null ? '' : jade_interp)) + "</p></div><p class=\"login-wrapper\"><a href=\"#\" class=\"login-link-openid\"><img" + (jade.attr("alt", i18n('auth-openid'), true, false)) + "/></a><a href=\"#\" class=\"login-link-facebook\"><img" + (jade.attr("alt", i18n('auth-facebook'), true, false)) + "/></a><a href=\"#\" class=\"login-link-google\"><img" + (jade.attr("alt", i18n('auth-google'), true, false)) + "/></a></p></div><div class=\"auth-loggedin-openid\"><p class=\"auth-openid-name\"></p><p class=\"logout-wrapper\"><a href=\"#\" class=\"logout-link-openid\">" + (jade.escape((jade_interp = i18n('logout')) == null ? '' : jade_interp)) + "</a></p></div><div class=\"auth-loggedin-facebook\"><p class=\"auth-facebook-name\"></p><p class=\"logout-wrapper\"><a href=\"#\" class=\"logout-link-facebook\">" + (jade.escape((jade_interp = i18n('logout')) == null ? '' : jade_interp)) + "</a></p></div><div class=\"auth-loggedin-google\"><p class=\"auth-google-name\"></p><p class=\"logout-wrapper\"><a href=\"#\" class=\"logout-link-google\">" + (jade.escape((jade_interp = i18n('logout')) == null ? '' : jade_interp)) + "</a></p></div><p class=\"post-action\"><input type=\"submit\"" + (jade.attr("value", i18n('postbox-submit'), true, false)) + "/></p></section><p class=\"markdown-note\"><a target=\"_blank\" href=\"https://en.wikipedia.org/wiki/Markdown\">Markdown</a>" + (jade.escape(null == (jade_interp = i18n('markdown-note')) ? "" : jade_interp)) + "</p><p class=\"login-note\"><span class=\"login-note-service\"></span>" + (jade.escape(null == (jade_interp = i18n('login-note')) ? "" : jade_interp)) + "</p></div></div>");}.call(this,"author" in locals_for_with?locals_for_with.author:typeof author!=="undefined"?author:undefined,"email" in locals_for_with?locals_for_with.email:typeof email!=="undefined"?email:undefined,"i18n" in locals_for_with?locals_for_with.i18n:typeof i18n!=="undefined"?i18n:undefined,"website" in locals_for_with?locals_for_with.website:typeof website!=="undefined"?website:undefined));;return buf.join("");
};  return fn;});
...
if ( bool(comment.pictureURL))
{
buf.push("<a" + (jade.attr("href", '' + (comment.website) + '', true, false)) + "><img" + (jade.attr("src", '' + (comment.pictureURL) + '', true, false)) + "/></a>");
}
else
{
buf.push("<svg" + (jade.attr("data-hash", '' + (comment.hash) + '', true, false)) + "></svg>");
}
buf.push("</div>");
}
...
buf.push("<span class=\"spacer\">&bull;</span>");
if ( bool(comment.role_name))
{
buf.push("<span" + (jade.cls(["role " + (comment.role_name) + ""], [true])) + ">" + (jade.escape((jade_interp = comment.role_string) == null ? '' : jade_interp)) + "</span><span class=\"spacer\">&bull;</span>");
}
else if ( comment.auth_method == 'openid')
{
buf.push("<span class=\"identifier-heading\">" + (jade.escape(null == (jade_interp = i18n('openid-identifier')) ? "" : jade_interp)) + "</span><span class=\"identifier-value\">" + (jade.escape(null == (jade_interp = comment.auth_id) ? "" : jade_interp)) + "</span><span class=\"spacer\">&bull;</span>");
}
buf.push("<a" + (jade.attr("href", '#isso-' + (comment.id) + '', true, false)) + " class=\"permalink\"><time" + (jade.attr("title", '' + (humanize(comment.created)) + '', true, false)) + (jade.attr("datetime", '' + (datetime(comment.created)) + '', true, false)) + "></time></a><span class=\"note\">" + (jade.escape(null == (jade_interp = comment.mode == 2 ? i18n('comment-queued') : comment.mode == 4 ? i18n('comment-deleted') : '') ? "" : jade_interp)) + "</span></div><div class=\"text\">");
if ( comment.mode == 4)
{
buf.push("<p>&nbsp;</p>");
}
...
define('jade!app/text/openid-identifier', function () {  var fn = function template(locals) {
var buf = [];
var jade_mixins = {};
var jade_interp;
;var locals_for_with = (locals || {});(function (i18n) {
buf.push("<form id=\"isso-openid-login-form\" method=\"GET\"><div class=\"isso-openid-form-box\"><p class=\"isso-openid-intro-line\"><img id=\"isso-openid-logo\" alt=\"OpenID logo\"/>" + (jade.escape(null == (jade_interp = i18n('openid-intro')) ? "" : jade_interp)) + "</p><p class=\"isso-openid-login-line\"><input type=\"text\" id=\"isso-openid-identifier\" name=\"isso-openid-identifier\"/><input type=\"submit\" id=\"isso-openid-submit\"" + (jade.attr("value", i18n('login'), true, false)) + "/></p><p class=\"isso-openid-hint-line\">" + (jade.escape(null == (jade_interp = i18n('openid-hints')) ? "" : jade_interp)) + "</p></div></form>");}.call(this,"i18n" in locals_for_with?locals_for_with.i18n:typeof i18n!=="undefined"?i18n:undefined));;return buf.join("");
};  return fn;});

define('app/jade',["libjs-jade-runtime", "app/utils", "jade!app/text/postbox", "jade!app/text/comment", "jade!app/text/comment-loader", "jade!app/text/openid-identifier"], function(runtime, utils, tt_postbox, tt_comment, tt_comment_loader, tt_openid_identifier) {
    "use strict";
    ...
    load("openid-identifier", tt_openid_identifier);
...
define('app/auth/openid',["app/dom", "app/config", "app/api", "app/jade", "app/i18n"], function($, config, api, jade, i18n) {
...
define('app/auth/facebook',["app/dom", "app/config", "app/api"], function($, config, api) {
...
define('app/auth/google',["app/dom", "app/config", "app/api"], function($, config, api) {
