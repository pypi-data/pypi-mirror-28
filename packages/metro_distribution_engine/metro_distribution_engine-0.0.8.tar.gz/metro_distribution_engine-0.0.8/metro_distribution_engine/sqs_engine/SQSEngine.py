...
class SQSEngine(BaseEngine):
    def __init__(self):
        ...
        self.AWS_ID = os.environ['AWS_ID'] # TODO: Put this in a project-sensible location.
    ...
    def create_datasource(self, datasource):
        ...
        :return topic_arn:
        '''
        topic_arn = self._create_topic(self._generate_topic_name(datasource['name']))
    ...
    def attach(self, project, datasource):
        ...
        :param project:
        :param datasource:
        :return queue_arn, topic_arn:
        '''
        queue_name = self._generate_queue_name(project['name'], datasource['name']) # Generate a name for the queue
        ...
        self._update_filter_policy(subscription_arn, project['name'])
    ...
    def detach(self, metro_subscription):
        ...
        self.sqs_client.set_queue_attributes(QueueUrl=metro_subscription['queue_url'],
    ...
    def send_metric(self, datasource_name, project_names, metric):
        ...
        topic_arn = self._generate_topic_name(datasource_name)
    ...
    def get_metrics(self, metro_subscription, count):
        '''Returns and deletes :count: messages from the queue.
        Note that count can only have a max value of 10. This is an API
        limitation.'''

        if count > 10:
            # HARD LIMIT ON THE MAX MESSAGES THAT CAN BE RECEIVED.
