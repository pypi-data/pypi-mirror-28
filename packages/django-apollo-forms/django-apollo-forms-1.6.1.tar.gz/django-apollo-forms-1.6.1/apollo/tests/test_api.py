...
from apollo.models import Form, FormFieldTemplate
...
class APITestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.user = User.objects.create_user(username='tester', email='test@test.com', password='mytestapi')
...
class TestListFormSubmissions(FormsAPITestCase):
    ...
    def test_staff_permissions_required_to_list_submissions(self):
    ...
    def test_staff_permissions_required_to_update_submission(self):
    ...
    def test_staff_permissions_required_to_delete_submission(self):
        submission = FormSubmissionFactory(
            form=self.form,
            raw_data={'fields': [{'name': 'first_name', 'value': 'bobby'}, {'name': 'last_name', 'value': 'stein'}]}
        )
