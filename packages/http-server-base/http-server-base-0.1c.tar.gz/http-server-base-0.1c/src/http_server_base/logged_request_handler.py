...
class Logged_RequestHandler(RequestHandler):
    ...
    # Should override
    logger_name = 'http_server.logged_request_handler'
    ...
    def initialize(self, *args, **kwargs):
        ...
        self.request:HTTPRequest = self.request
    ...
    def generate_proxy_request(self, parent_request_handler):
        from tornado.httpclient import HTTPRequest
        request_obj:HTTPRequest = parent_request_handler.request
    ...
    @asynchronous
    def proxy_request_async(self, *args, **kwargs):
        from tornado.httpclient import AsyncHTTPClient
        # requested_url = tornado.httpclient.HTTPRequest()
        # requested_method = request_obj.method


        _client = AsyncHTTPClient()
        _proxy_request = self.generate_proxy_request(self)
