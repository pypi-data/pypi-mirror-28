...
def timestamp_build():
    """timestamp_build() -> int"""
    return _wiredtiger.timestamp_build()
...
WT_STAT_CONN_LOG_FORCE_CKPT_SLEEP = _wiredtiger.WT_STAT_CONN_LOG_FORCE_CKPT_SLEEP
...
WT_STAT_CONN_TREE_DESCEND_BLOCKED = _wiredtiger.WT_STAT_CONN_TREE_DESCEND_BLOCKED
...
WT_STAT_CONN_TXN_COMMIT_QUEUE_HEAD = _wiredtiger.WT_STAT_CONN_TXN_COMMIT_QUEUE_HEAD
WT_STAT_CONN_TXN_COMMIT_QUEUE_INSERTS = _wiredtiger.WT_STAT_CONN_TXN_COMMIT_QUEUE_INSERTS
WT_STAT_CONN_TXN_COMMIT_QUEUE_LEN = _wiredtiger.WT_STAT_CONN_TXN_COMMIT_QUEUE_LEN
