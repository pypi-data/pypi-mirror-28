...
def read_tuple_to_read_tensor(args, read_tuples, ref_start, insert_dict):
	...
	print('Try to make a read tensor with shape:', tensor.shape, 'rad toop 0:', read_tuples[0])
...
def sequence_and_qualities_from_read(args, read, ref_start, insert_dict):
	...
	rqual = read.seq[:args.window_size].tolist()
...
def args_and_model_from_semantics(semantics_json):
	...
	print('Cigar 2 code is:', CIGAR2CODE)
	return args, model
