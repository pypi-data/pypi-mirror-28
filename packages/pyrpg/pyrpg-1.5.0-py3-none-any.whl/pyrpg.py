...
def enemy_encounter(level, **kwargs):
    ...
    b = Battle(foelvl=level, name=name, xp=xp, gold=gold,namelist=kwargs.get('namelist'), spell_one=kwargs.get('spell _one'), spell_two=kwargs.get('spell_two'), spell_three=kwargs.get('spell_three'))
    b.battle(level)
