...
class QuestionIndexViewTests(TestCase):
	def test_no_questions(self):
		"""
		se não existirem questões, é mostrada uma mensagem apropriada
		"""
	...
	def test_past_question(self):
		"""
		Questões com uma data de publicação no passado são mostradas na index page
		"""
		create_question(question_text="Past questions", days=-30)
		response = self.client.get(reverse('polls:index'))
		self.assertContains(response, "Past questions")
