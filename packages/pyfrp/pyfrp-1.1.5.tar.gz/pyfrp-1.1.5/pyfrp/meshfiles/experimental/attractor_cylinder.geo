...
// Upper circle
Point(idMin+1) = {center_x, center_y, 0, volSize_px}; 
Point(idMin+2) = {-radius+center_x, center_y, 0, volSize_px};
Point(idMin+3) = {center_x, center_y+radius, 0, volSize_px};
Point(idMin+4) = {center_x+radius, center_y, 0, volSize_px};
Point(idMin+5) = {center_x, -radius+center_y, 0, volSize_px};
Point(idMin+6) = {center_x, center_y, -height, volSize_px}; 
Point(idMin+7) = {-radius+center_x, center_y, -height, volSize_px};
...
Point(11) = {center_x, center_y, -height/2., volSize_px};
...
Field[2] = Threshold;
Field[2].IField = 1;
Field[2].LcMin = volSize_px / 5;
Field[2].LcMax = volSize_px;
Field[2].DistMin = 50;
Field[2].DistMax = 200;
