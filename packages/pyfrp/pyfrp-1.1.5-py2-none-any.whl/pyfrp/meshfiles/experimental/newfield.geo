...
Field[1] = Box;
Field[1].VIn = 2*volSize_fine;
Field[1].VOut = volSize_px;
Field[1].XMin = center_x-sl_refined; 
Field[1].XMax = center_x+sl_refined;
Field[1].YMin = center_y-sl_refined;
Field[1].YMax = center_y+sl_refined;
Field[1].ZMin = -2*sl_height-sl_width;
Field[1].ZMax = -2*sl_height+sl_width;
