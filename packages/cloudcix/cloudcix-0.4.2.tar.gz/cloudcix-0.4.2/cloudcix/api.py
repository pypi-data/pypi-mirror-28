...
class scheduler:
    ...
    **Services**
    ...
    - **Execute Task**
        ...
        - ``cloudcix.api.scheduler.execute_task.<method>``
        - Available Methods
    ...
    - **Task**
        ...
        - A Task is a recurring transaction that will run from time to time
          according to a set of rules defined by the User.
        - ``cloudcix.api.scheduler.task.<method>``
        - Available Methods
    ...
    - **Task Log**
        - The TaskLog service allows the User to get all the details about
          processed recurring transactions
        - Every time a recurring task is processed, a log is created.
        - The Log contains if the transaction was successful or failed, along
          with details of why it failed
        - ``cloudcix.api.scheduler.task_log.<method>``
        - Available Methods
...
class scm:
    ...
    **Services**
    ...
    - **Bin**
        - This service allows the Users to manage their Bins. A Bin is a
          classification for SKUs used to manage their inventory
        - ``cloudcix.api.scm.bin.<method>``
        - Available Methods
    ...
    - **Bin SKU**
        ...
        - ``cloudcix.api.scm.bin_sku.<method>``
        - Available Methods
    ...
    - **Critical BOM**
        - This service allows the User to manage an SKU's Bill of Materials
          (BOM)
        - A BOM is a list of the raw materials, sub-assemblies, intermediate
          assemblies, sub-components, parts, and the quantities of each needed
          to manufacture an end product
        - ``cloudcix.api.scm.critical_bom.<method>``
        - Available Methods
...
class security:
    ...
    **Services**
    ...
    - **Security Event**
        - A Security Event is a transaction that occurs when a person enters or
          exits a building.
        - This service is used to track Users arriving at an Address
        - ``cloudcix.api.security.security_event.<method>``
        - Available Methods
    ...
    - **Security Event Logout**
        ...
        - A Security Event for leaving cannot be created unless the User has
          first logged their arrival to an Address
        - ``cloudcix.api.security.security_event.<method>``
        - Available Methods
            - ``cloudcix.api.security.security_event.create``
