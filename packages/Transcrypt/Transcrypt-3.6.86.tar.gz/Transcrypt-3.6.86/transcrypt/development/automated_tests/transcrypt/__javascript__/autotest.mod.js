	(function () {
		...
		__nest__ (byte_arrays, '', __init__ (__world__.byte_arrays));
		...
		__nest__ (method_and_class_decorators, '', __init__ (__world__.method_and_class_decorators));
		__nest__ (module_builtin, '', __init__ (__world__.module_builtin));
		__nest__ (module_cmath, '', __init__ (__world__.module_cmath));
		__nest__ (module_datetime, '', __init__ (__world__.module_datetime));
		if (__in__ ('__esv6__', __symbols__)) {
