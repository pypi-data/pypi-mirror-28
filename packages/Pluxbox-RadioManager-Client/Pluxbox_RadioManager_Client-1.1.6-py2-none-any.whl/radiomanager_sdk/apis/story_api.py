...
class StoryApi(object):
    ...
    def create_story(self, data, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_story(data, callback=callback_function)
    ...
    def create_story_with_http_info(self, data, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_story_with_http_info(data, callback=callback_function)
    ...
    def delete_story_by_id(self, id, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_story_by_id(id, callback=callback_function)
    ...
    def delete_story_by_id_with_http_info(self, id, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_story_by_id_with_http_info(id, callback=callback_function)
    ...
    def get_story_by_id(self, id, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_story_by_id(id, callback=callback_function)
    ...
    def get_story_by_id_with_http_info(self, id, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_story_by_id_with_http_info(id, callback=callback_function)
    ...
    def list_stories_with_http_info(self, **kwargs):
        ...
        all_params = ['page', 'item_id', 'model_type_id', 'tag_id', 'limit', 'order_by', 'order_direction', 'external_station_id']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'limit' in params and params['limit'] > 50:
            raise ValueError("Invalid value for parameter `limit` when calling `list_stories`, must be a value less than or equal to `50`")
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `list_stories`, must be a value greater than or equal to `1`")
    ...
    def update_story_by_id(self, id, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_story_by_id(id, callback=callback_function)
    ...
    def update_story_by_id_with_http_info(self, id, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_story_by_id_with_http_info(id, callback=callback_function)
