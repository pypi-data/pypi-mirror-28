...
5. Find source files
  ...
  - Navigate to `webpack:// -> [your/repo/path]] -> ipop-components -> src` to find your component source files.
...
3. Run the dash layout you want to test
        ...
        # Import ipop-components to your layout, then run it:
