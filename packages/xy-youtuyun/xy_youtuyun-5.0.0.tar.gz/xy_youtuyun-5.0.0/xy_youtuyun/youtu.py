...
class YouTu(object):
    ...
    def FaceMix(self, src_image, model_id=0, return_type=0):
        ...
        MODEL_TYPE = {
            ...
            38:'cf_lover_sunshang',#孙尚香
            39:'cf_lover_libai',#李白
            40:'cf_lover_fanli',#范蠡
            41:'cf_fuwa_yasuiqian',#压岁钱
            42:'cf_fuwa_qiji',#我就是奇迹
        }
    ...
    def PicTalk(self,image=''):
        req_type = 'cgi-bin/pitu_open_access_for_youtu.fcg'
        headers = self.get_headers(req_type)
        url = 'http://api.ai.qq.com/fcgi-bin/vision/vision_imgtotext'
        data = {
            "app_id": self._appid
        }
