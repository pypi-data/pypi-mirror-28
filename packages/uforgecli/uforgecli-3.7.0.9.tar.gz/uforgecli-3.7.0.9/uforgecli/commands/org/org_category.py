...
class Org_Category_Cmd(Cmd, CoreGlobal):
        ...
        def arg_delete(self):
                ...
                optional.add_argument('--names', dest='names', nargs='+', required=False, help="One or more categories to delete (category names provided) in the organization.  Names separated by commas (e.g. cat 1, cat 2, cat 3).")
        ...
        def do_delete(self, args):
                try:
                        ...
                        if doArgs.names is not None and doArgs.ids is not None :
                                printer.out("You cannot provide name and id parameters at the same time", printer.ERROR)
                                return 0
