...
class Org_Golden_Cmd(Cmd, CoreGlobal):
        ...
        def do_create(self, args):
                try:
                        ...
                        result = self.api.Orgs(org.dbId).Distributions(goldenId).Goldens.Add(Language=doArgs.language, Edition=doArgs.edition, Type=doArgs.type, Goldendate=doArgs.goldenDate, Filename=doArgs.goldenName, Force=doArgs.force, body=None)
