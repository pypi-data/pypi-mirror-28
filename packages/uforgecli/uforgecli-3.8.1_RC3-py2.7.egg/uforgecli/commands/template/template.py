...
class Template_Cmd(Cmd, CoreGlobal):
        ...
        def do_info(self, args):
                try:
                        ...
                        table.add_row(["Last Modified", userAppliance.lastModified.strftime("%Y-%m-%d %H:%M:%S")])

                        if userAppliance.lastPkgUpdate is not None:
                            table.add_row(["Last Package Update",
                                           userAppliance.lastPkgUpdate.strftime("%Y-%m-%d %H:%M:%S")])
