...
function generate_rfid(wizard){
    wizard.steps('add', {
        ...
        content: '<div class="row text-center">\n' +
        '           <div class="col-md-6">\n' +
        '               <h4>Read or Enter the RFID Code</h4>\n' +
        ...
        '                           <p>RFID codes are entered manually.  An NFC-enabled smartphone or desktop reader can read the code for manual entry.</p>\n' +
        '                           <p>The RFID code should entered in <strong>hexadecimal</strong> form without <strong>:</strong> separators.</p>\n' +
        '                       </section>' +
        '                       <section>\n' +
