...
(function() {
    var timeline = new vis.Timeline($('#timeline_visualization')[0],
        items, {
            ...
            $('#report_range span').html(moment(event.start).format('MMMM D, hh:mm A')
                + ' - ' + moment(event.end).format('MMMM D, hh:mm A'));
        });
    ...
    $('#report_range').daterangepicker({
        ...
        ranges: {
            ...
            "Last Month": [moment().subtract(1, 'month').startOf('month').startOf('day'),
