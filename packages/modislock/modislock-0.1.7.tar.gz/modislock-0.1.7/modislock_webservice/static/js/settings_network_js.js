...
e.preventDefault()})}(jQuery);(function(){$("#dhcp_mode").change(function(){(this.checked)?network_disable():network_enable();});})();function network_disable(){$("input[id$='address']").prop('disabled',true);}
