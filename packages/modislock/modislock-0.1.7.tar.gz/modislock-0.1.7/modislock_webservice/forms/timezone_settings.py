...
class TimeZoneSettings(FlaskForm):
    """
.. class:: TimeZoneSettings(Form)

    """
    hours = IntegerField('Hours', validators=[DataRequired(), NumberRange(min=0, max=23)])
    minutes = IntegerField('Minutes', validators=[DataRequired(), NumberRange(min=0, max=59)])

    tz_zone = SelectField('Time Zone',
    ...
    submit_btn = SubmitField('Save Time Settings')
