...
_QUERY_PAYLOAD = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='get_asset_info', full_name='iroha.protocol.Query.Payload.get_asset_info', index=9,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='query_counter', full_name='iroha.protocol.Query.Payload.query_counter', index=11,
