...
_GETACCOUNTDETAIL = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='detail', full_name='iroha.protocol.GetAccountDetail.detail', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_QUERY_PAYLOAD = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='get_transactions', full_name='iroha.protocol.Query.Payload.get_transactions', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='get_account_assets', full_name='iroha.protocol.Query.Payload.get_account_assets', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='get_account_detail', full_name='iroha.protocol.Query.Payload.get_account_detail', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='get_roles', full_name='iroha.protocol.Query.Payload.get_roles', index=9,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='get_role_permissions', full_name='iroha.protocol.Query.Payload.get_role_permissions', index=10,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='get_asset_info', full_name='iroha.protocol.Query.Payload.get_asset_info', index=11,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='query_counter', full_name='iroha.protocol.Query.Payload.query_counter', index=12,
