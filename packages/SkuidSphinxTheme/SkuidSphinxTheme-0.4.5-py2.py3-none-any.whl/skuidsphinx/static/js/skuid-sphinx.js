...
$( document ).ready(function() {
  ...
  if (document.querySelectorAll('.collapsible').length > 1) {$('#showAll').attr('style','display:inline-block;');$('#hideAll').attr('style','display:inline-block;')}
})
...
$(document).on("keydown", function (e) { if (e.keyCode == 70 && e.ctrlKey || e.metaKey) {
