...
from ._server import _register_exception_type, AnvilWrappedError, SerializationError, InternalError, InvalidResponseError, RuntimeUnavailableError, QuotaExceededError, UplinkDisconnectedError, ExecutionTerminatedError, TimeoutError, NoServerFunctionError, CookieError, _FailError, http_endpoint, api_request as request, HttpResponse, cookies
...
def connect(key, url='wss://anvil.works/uplink', quiet=False):
    global _key, _url, _fatal_error, _quiet
    _key = key
    _url = url
