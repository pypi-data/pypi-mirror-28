...
## actions are (for 'schedstr' run `bomail help datestr`):
##   open
##   close
##   schedule schedstr
##   tag first-tag, second-tag, third-tag
## ---------------------------------------------------

## Example to tag and schedule for 1 day later (remove '#' to actually use it)
#-from Facebook
#OR -from no-reply@facebook.com
#tag social
#AND schedule p1d
