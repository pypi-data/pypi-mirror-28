...
from .tools import *
from .exception import MissingVersionInRule, CannotFindAnyVersion, MissingFile
...
def extract_version_from_rules(rules):
    ...
    check_version_are_identical(version_collected)
...
class Rule:
    ...
    def collect(self):
        try:
            ...
            raise MissingFile(self.file_name)
