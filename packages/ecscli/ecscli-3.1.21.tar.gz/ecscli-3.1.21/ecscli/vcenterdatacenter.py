...
def create_parser(subcommand_parsers, common_parser):
    ...
    create_parser = subcommand_parsers.add_parser(
        'create',
        description='ECS vcenterdatacenter Create CLI usage.',
...
def delete_parser(subcommand_parsers, common_parser):
    ...
    delete_parser = subcommand_parsers.add_parser(
        'delete',
        description='ECS vcenterdatacenter Delete CLI usage.',
        parents=[common_parser],
        conflict_handler='resolve',
...
def show_parser(subcommand_parsers, common_parser):
    ...
    show_parser = subcommand_parsers.add_parser(
        'show',
        description='ECS vcenterdatacenter Show CLI usage.',
        parents=[common_parser],
        conflict_handler='resolve',
...
def get_hosts_parser(subcommand_parsers, common_parser):
    ...
    get_hosts_parser = subcommand_parsers.add_parser(
        'get-hosts',
        description='ECS vcenterdatacenter get hosts CLI usage.',
        parents=[common_parser],
        conflict_handler='resolve',
...
def get_clusters_parser(subcommand_parsers, common_parser):
    ...
    get_clusters_parser = subcommand_parsers.add_parser(
        'get-clusters',
        description='ECS vcenterdatacenter get clusters CLI usage.',
        parents=[common_parser],
        conflict_handler='resolve',
...
def query_parser(subcommand_parsers, common_parser):
    ...
    query_parser = subcommand_parsers.add_parser(
        'query',
        description='ECS vcenterdatacenter Query CLI usage.',
        parents=[common_parser],
        conflict_handler='resolve',
...
def list_parser(subcommand_parsers, common_parser):
    ...
    list_parser = subcommand_parsers.add_parser(
        'list',
        description='ECS vcenterdatacenter List CLI usage.',
        parents=[common_parser],
        conflict_handler='resolve',
...
def vcenterdatacenter_parser(parent_subparser, common_parser):
    ...
    parser = parent_subparser.add_parser(
        'vcenterdatacenter',
        description='ECS vcenterdatacenter CLI usage',
        parents=[common_parser],
        conflict_handler='resolve',
