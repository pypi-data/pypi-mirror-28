...
class ECSInterpreter(cmd.Cmd):

    prompt = 'ECS_CLI> '
    parser = Parser()
    cf = ""

    def do_ecscli(self, command):
        # pass
        # Command to be executed
        command = "ecscli " + command
    ...
    def complete_ecscli(self, text, line, begidx, endidx):
