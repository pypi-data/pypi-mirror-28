...
async def resolve(dnsq, stream_id, proto):
    ...
    try:
        ...
        proto.on_answer(stream_id, None)
...
class H2Protocol(asyncio.Protocol):
    ...
    def stream_complete(self, stream_id: int):
        ...
        if method == 'GET':
            ...
            if constants.DOH_BODY_PARAM in params and \
                ...
                body = utils.doh_b64_decode(params[constants.DOH_BODY_PARAM][0])
            else:
    ...
    def on_answer(self, stream_id, dnsr):
        headers = {
    ...
    def return_XXX(self, stream_id: int, status: int, body: str = b''):
        """
