...
class mypoolin_imps(object):
	...
	__base_url = "https://hmacsdk.mypoolin.com/merchants_imps"

	def __init__(self, username, secret):
		super(mypoolin_imps, self).__init__()
	...
	def request_imps_single(self,beneficiary_account_number,beneficiary_ifsc_code,beneficiary_amount,beneficiary_name):
		resp = self.__hmac_requests("POST","/request_imps_single",
	...
	def request_imps_single_async(self,beneficiary_account_number,beneficiary_ifsc_code,beneficiary_amount):
		resp = self.__hmac_requests("POST","/request_imps_single_async",
			beneficiary_account_number=beneficiary_account_number,
			beneficiary_ifsc_code=beneficiary_ifsc_code,
			beneficiary_amount=beneficiary_amount,
			beneficiary_name=beneficiary_name)
