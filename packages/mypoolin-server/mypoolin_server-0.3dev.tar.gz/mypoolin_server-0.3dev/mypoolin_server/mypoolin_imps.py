...
class mypoolin_imps(object):
	...
	def request_imps_single(self,beneficiary_account_number,beneficiary_ifsc_code,beneficiary_amount):
		resp = self.__hmac_requests("POST","/request_imps_single",beneficiary_account_number=beneficiary_account_number,beneficiary_ifsc_code=beneficiary_ifsc_code,beneficiary_amount=beneficiary_amount)
	...
	def request_imps_single_async(self,beneficiary_account_number,beneficiary_ifsc_code,beneficiary_amount):
		resp = self.__hmac_requests("POST","/request_imps_single_async",beneficiary_account_number=beneficiary_account_number,beneficiary_ifsc_code=beneficiary_ifsc_code,beneficiary_amount=beneficiary_amount)
		return self.__json_validation_and_return(resp.text)
