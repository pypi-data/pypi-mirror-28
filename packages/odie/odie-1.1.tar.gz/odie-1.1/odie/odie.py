...
class Odie:
    ...
    def put_object(self, table=None, name=None, data=None):
        ...
        if table is None and name is None and data is None:
    ...
    def copy_object(self, source_object=None, dest_object=None, table=None):
        ...
        try:
            self.put_object(table=table, name=dest_object, data=source_data)
            return True
        except Exception, e:
            print(e)
            raise Exception("Unable to copy object")
    ...
    def delete_odie_record(self, delete_data=None, table=None,name=None):
        """
        ...
        answer = questions("Please make sure that once you delete you cannot revert it.\n are you sure to do it?(Y/N)>>")
