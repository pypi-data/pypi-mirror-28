...
# installed yet)
version = re.search(
    "__version__ = '([^']+)'", text_of('lifoid_dialogflow/__init__.py')
).group(1)


NAME = 'lifoid-dialogflow'
VERSION = version
DESCRIPTION = 'Dialogflow plugin for Lifoid'
KEYWORDS = 'NLP'
AUTHOR = 'Romary Dupuis'
AUTHOR_EMAIL = 'romary@me.com'
URL = 'https://github.com/romaryd/lifoid-dialogflow'
