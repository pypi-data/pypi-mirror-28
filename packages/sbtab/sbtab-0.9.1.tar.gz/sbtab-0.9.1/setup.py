...
setup(name='sbtab',version='0.9.1',description='sbtab',long_description='SBtab - Standardised Data Tables for Systems Biology',url='https://www.sbtab.net',author='Timo Lubitz',author_email='timo.lubitz@gmail.com',license='MIT',classifiers=['Development Status :: 4 - Beta','Intended Audience :: Developers', 'Topic :: Software Development', 'Programming Language :: Python :: 2.7'],keywords='modelling systems biology standard format data table',packages=find_packages(),install_requires=['python-libsbml','tablib'],python_requires='<=2.7',include_package_data=True)
