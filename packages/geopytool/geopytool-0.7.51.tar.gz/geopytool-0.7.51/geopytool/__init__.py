...
class Ui_MainWindow(QtWidgets.QMainWindow):
    ...
    def goCnBBS(self):
        webbrowser.open('http://bbs.geopytool.com/-f2.html')

    def goEnBBS(self):
        webbrowser.open('http://bbs.geopytool.com/English-Forum-f3.html')
    ...
    def checkVersion(self):
        ...
        url = 'https://raw.githubusercontent.com/chinageology/GeoPython/master/geopytool/CustomClass.py'
