...
# def help():
#     available_sizes = ["two_in_docx two_in_ppt one_in_docx one_in_ppt".split()]
#     print("the available commands are:")
#     for s in available_sizes:
#         print("\t" + s)

@TraceCalls()
def plot_prf(path = "", printsize = "two_in_docx"):
    """
    ...
    Common mistake:
        If you cange your .pcr, remember to run FullProf to see the effect of the updated
        parameters or added phases. This script stupidly reads in the .out and .prf files.
        Any changes to especially phase names will certainly result in phase names found
        in plot is unchanged.
    ...
    if printsize == "two_in_docx":
        ...
        subplot_right_space = 6.5
        dotsize = 1 #
        linewidth = 1
        refinfo_pos = (1.02,-0.07)
        ylabelpos_pre = (0.01,1.05)
        ylabelpos_post = (-0.27,0.50)
        xlabelpos_pre = (1.05,0.05)
        ...
        dotsize = 2
        linewidth = 2
        subplot_right_space = 7.5
        refinfo_pos = (1.03,-0.06)
        ylabelpos_pre = (-0.008,1.05)
        ylabelpos_post = (-0.18,0.50)
        ...
        dotsize = 2
        linewidth = 2
        subplot_right_space = 6.6
        refinfo_pos = (1.015,-0.055)
        ylabelpos_pre = (-0.007,1.05)
        ylabelpos_post = (-0.14,0.50)
        xlabelpos_pre = (1.05,-0.043)
        xlabelpos_post = (0.50,-0.07)
        ...
        dotsize = 3
        linewidth = 2
        subplot_right_space = 4.5
        refinfo_pos = (1.01,-0.065)
        ylabelpos_pre = (-0.009,1.05)
        ylabelpos_post = (-0.09,0.50)
        xlabelpos_pre = (1.05,-0.043)
        xlabelpos_post = (0.50,-0.07)
    ...
    for folder in folders:
        ...
        # import pdb; pdb.set_trace(); print("None =",None)
