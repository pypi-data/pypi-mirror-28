...
class LuaListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by LuaParser#todo4.
    def enterTodo4(self, ctx:LuaParser.Todo4Context):
        pass

    # Exit a parse tree produced by LuaParser#todo4.
    def exitTodo4(self, ctx:LuaParser.Todo4Context):
        pass
    ...
    # Enter a parse tree produced by LuaParser#todo3.
    def enterTodo3(self, ctx:LuaParser.Todo3Context):
        pass

    # Exit a parse tree produced by LuaParser#todo3.
    def exitTodo3(self, ctx:LuaParser.Todo3Context):
        pass
    ...
    # Enter a parse tree produced by LuaParser#comment_rule.
    def enterComment_rule(self, ctx:LuaParser.Comment_ruleContext):
        pass

    # Exit a parse tree produced by LuaParser#comment_rule.
    def exitComment_rule(self, ctx:LuaParser.Comment_ruleContext):
        pass


    # Enter a parse tree produced by LuaParser#ws_rule.
    def enterWs_rule(self, ctx:LuaParser.Ws_ruleContext):
        pass

    # Exit a parse tree produced by LuaParser#ws_rule.
    def exitWs_rule(self, ctx:LuaParser.Ws_ruleContext):
        pass


    # Enter a parse tree produced by LuaParser#commaSymbol.
    def enterCommaSymbol(self, ctx:LuaParser.CommaSymbolContext):
        pass

    # Exit a parse tree produced by LuaParser#commaSymbol.
    def exitCommaSymbol(self, ctx:LuaParser.CommaSymbolContext):
        pass


    # Enter a parse tree produced by LuaParser#eqSymbol.
    def enterEqSymbol(self, ctx:LuaParser.EqSymbolContext):
        pass

    # Exit a parse tree produced by LuaParser#eqSymbol.
    def exitEqSymbol(self, ctx:LuaParser.EqSymbolContext):
        pass
