...
class Gadget:
	...
	def __init__(self, num, addr, raw):
		...
		self.spInc = 0 # How much have Stack Pointer been incremented by 
	...
	def translateFullRegAssignement( self, expr, op ):
		...
		#print("DEBUG, reg is " + str(reg) + "offset is " + str(offset) + " expr is " + str(expr))
