...
class Device:
    ...
    :param group: an IoT.Group reference
    ...
    def __init__(self, group, name, unit=True, advanced=False, development=False):
        self.group = group
    ...
    def time(self):
        ...
        """
        uri = self.group.server_url + "/" + self.name + "/device_status"

        res = self.request.get(uri, self.group.timeout)
    ...
    def get_args(self, msg):
        ...
        """
        uri = self.group.server_url + "/" + self.name + "/" + str(msg)
        return self.request.get(uri, self.group.timeout)
