...
static int __pyx_pymod_exec__pwm(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  ...
  /*--- Type init code ---*/
  __pyx_ptype_2bx_5motif_4_pwm_ndarray = __Pyx_ImportType("numpy", "ndarray", sizeof(PyArrayObject), 0); if (unlikely(!__pyx_ptype_2bx_5motif_4_pwm_ndarray)) __PYX_ERR(0, 12, __pyx_L1_error)
  /*--- Type import code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init bx.motif._pwm", 0, __pyx_lineno, __pyx_filename);
    }
