...
from civil.editor.edit_objective import EditObjective
from civil.editor.objectiveviewitem import ObjectiveItem


class ObjectiveView(QtWidgets.QListView):
    """
    This class...
    """
    ...
    def __init__(self, parent):
        ...
        self.popup.insertItem('New', self.new, QtCore.Qt.CTRL + QtCore.Qt.Key_N, ObjectiveView.NEW)
        self.popup.insertItem('Edit', self.edit, QtCore.Qt.CTRL + QtCore.Qt.Key_E, ObjectiveView.EDIT)
        self.popup.insertItem('Delete', self.delete, QtCore.Qt.CTRL + QtCore.Qt.Key_D, ObjectiveView.DELETE)
    ...
    def new(self):
        ...
        objective = Objective(ObjectiveView.nextid)
    ...
    def mapClickedLeft(self, x, y, hexx, hexy):
        ...
        # gfx updates
        globals.mapview.paintEvent(QtGui.QPaintEvent(QtCore.QRect(oldpos[0], oldpos[1], 60, 60)))
