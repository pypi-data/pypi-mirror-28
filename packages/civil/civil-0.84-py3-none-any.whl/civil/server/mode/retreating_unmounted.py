...
class RetreatingUnmounted(Mode):
    """
    This implements the mode 'retreating'. It is used by cavalry units when they are retreating in a
    unmounted mode, either by having taken a punishment or when the player has chosen to retreat the
    ...
    def __init__(self):
        ...
        """
        # call superclass
        Mode.__init__(self, "retreatingunmounted", "retreating")
