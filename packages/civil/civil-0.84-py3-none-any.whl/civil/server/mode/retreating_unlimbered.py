...
class RetreatingUnlimbered(Mode):
    """
    This implements the mode 'retreating'. It is used by artillery units when they are retreating in
    a unlimbered state, either by having taken a punishment or when the player has chosen to retreat
    ...
    def __init__(self):
        ...
        """
        # call superclass
        Mode.__init__(self, "retreatingunlimbered", "retreating")
