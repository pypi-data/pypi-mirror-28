...
class RetreatingColumn(Mode):
    """
    This implements the mode 'retreating'. It is used by infantry units when they are retreating in
    column mode, either by having taken a punishment or when the player has chosen to retreat the
    ...
    def __init__(self):
        ...
        """
        # call superclass
        Mode.__init__(self, "retreatingcolumn", "retreating")
