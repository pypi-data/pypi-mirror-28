...
class RoutedArtillery(Mode):
    """
    This implements the mode 'routed'. It is used by artillery units when they are routed,
    ...
    def __init__(self):
        ...
        """
        # call superclass
        Mode.__init__(self, "routedartillery", "routed")
        ...
        self.onwait = ""
        self.onrally = ""
        self.ondisorganize = "disorganizedlimbered"
