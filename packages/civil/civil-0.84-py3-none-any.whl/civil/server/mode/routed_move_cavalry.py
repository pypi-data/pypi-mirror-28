...
class RoutedMoveCavalry(Mode):
    """
    This implements the mode 'routed'. It is used by cavalry units when they are routed and moving
    ...
    stops it will get the state 'routedcavalry'.
    """
    ...
    def __init__(self):
        ...
        """
        # call superclass
        Mode.__init__(self, "routedmovecavalry", "routed move")
