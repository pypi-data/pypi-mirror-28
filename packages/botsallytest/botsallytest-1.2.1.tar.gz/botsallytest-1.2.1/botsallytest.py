"""This is the "botsallytest.py" module and it provides one function called  print_lol()
...
def print_lol(the_list, indent = False, level = 0, fn = sys.stdout):
    """Prints a list of (possibly) nested lists.
       ...
       A fourth argument called "fn"(which defaults to sys.stdout) is used to control output
       sytle when we needed. """
