...
class Output(object):
    ...
    def send_rule_status(self, rule_id, active, error):
        ...
        try:
            rule_status = rook_pb2.RuleStatusUpdate()
            ...
            self._agent_com.send_rule_status_update(rule_status)
        except:
    ...
    def send_log_message(self, level, time, filename, lineno, text, formatted_message, arguments):
        with self._lock:
            if len(self._messages.log_messages) >= OutputConfiguration.MAX_ITEMS:
    ...
    def flush_messages(self):
        ...
        if messages.user_messages or messages.log_messages:
            try:
