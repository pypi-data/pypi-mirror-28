...
class FlowConfigurationDTO(object):
    ...
    def __init__(self, supports_managed_authorizer=False, supports_configurable_authorizer=False, supports_configurable_users_and_groups=False, auto_refresh_interval_seconds=None, current_time=None, time_offset=None):
        """
