...
class VariableRegistryUpdateRequestDTO(object):
    ...
    def __init__(self, request_id=None, process_group_id=None, uri=None, submission_time=None, last_updated=None, complete=False, failure_reason=None, update_steps=None, affected_components=None):
        """
