...
class ProcessGroupDTO(object):
    ...
    def __init__(self, id=None, parent_group_id=None, position=None, name=None, comments=None, variables=None, running_count=None, stopped_count=None, invalid_count=None, disabled_count=None, active_remote_port_count=None, inactive_remote_port_count=None, input_port_count=None, output_port_count=None, contents=None):
        """
