...
class AccessPolicyDTO(object):
    ...
    def __init__(self, id=None, parent_group_id=None, position=None, resource=None, action=None, component_reference=None, configurable=False, users=None, user_groups=None):
        """
