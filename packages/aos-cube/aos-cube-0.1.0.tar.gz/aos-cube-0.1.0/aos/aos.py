...
def _run_make(arg_list):
    if os.path.isdir(os.path.join('include', 'aos')) and (not os.path.isdir(os.path.join('external', 'aos-esptool'))):
        try:
            subprocess.Popen([git_cmd, 'clone', 'https://code.aliyun.com/vivid8710/aos-esptool.git',
                              os.path.join('external', 'aos-esptool')])
        except OSError as e:
            pass
