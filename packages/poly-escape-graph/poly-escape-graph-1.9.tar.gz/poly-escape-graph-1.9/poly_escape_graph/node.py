...
class Node(Flask):
    ...
    def publish(self, tags: List[str], files=None, **data):
        ...
        for subscriber in subscribers:
            ...
            print(requests.post(f'{subscriber.url}/listen', json={"tags": tags, "data": data}, files=files))
    ...
    def subscribe(self):
        ...
        for tag in data[TAGS]:
            ...
            print(f'{plugin.url} subscribe to {self.name} with tag {tag}')
    ...
    def unsubscribe(self):
        ...
        for tag in data[TAGS]:
            ...
            if plugin is not None:
                print(f'{plugin.url} unsubscribe to {self.name} with tag {tag}')
