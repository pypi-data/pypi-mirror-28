...
TERMCC_ALIAS_UNICODE = dict(TERMCC_UNICODE.items(), **{
    ...
    u':flashlight:': u'\U0001F526',
    u':elephant:': u'\U0001F418',
    u':TERMCC_modifier_fitzpatrick_type__1__2:': u'\U0001F3FB',
    u':TERMCC_modifier_fitzpatrick_type__3:': u'\U0001F3FC',
    u':TERMCC_modifier_fitzpatrick_type__4:': u'\U0001F3FD',
    u':TERMCC_modifier_fitzpatrick_type__5:': u'\U0001F3FE',
    u':TERMCC_modifier_fitzpatrick_type__6:': u'\U0001F3FF',
    u':end:': u'\U0001F51A',
    u':email:': u'\U00002709',
    u':envelope:': u'\U00002709',
    u':envelope_with_arrow:': u'\U0001F4E9',
...
CC = {
    ...
    ':black:': black(),
    ':reverse_black:': black_(),
    ':white:': white(),
    ':reverse_white:': white_(),

    ':red:': red(),
    ':reverse_red:': red_(),
    ':green:': green(),
    ':reverse_green:': green_(),

    ':yellow:': yellow(),
    ':reverse_yellow:': yellow_(),
    ':blue:': blue(),
    ':reverse_blue:': blue_(),
    ':magenta:': magenta(),
    ':reverse_magenta:': magenta_(),
    ':cyan:': cyan(),
    ':reverse_cyan:': cyan_(),
    ':light_gray:': lgray(),
    ':reverse_light_gray:': lgray_(),
    ':gray:': gray(),
    ':reverse_gray:': gray_(),

    ':light_red:': lred(),
    ':reverse_light_red:': lred_(),
    ':light_green:': lgreen(),
    ':reverse_light_green:': lgreen_(),
    ':light_yellow:': lyellow(),
    ':reverse_light_yellow:': lyellow_(),
    ':light_blue:': lblue(),
    ':reverse_light_blue:': lblue_(),
    ':light_magenta:': lmagenta(),
    ':reverse_light_magenta:': lmagenta_(),
    ':light_cyan:': lcyan(),
    ':reverse_light_cyan:': lcyan_(),
}
