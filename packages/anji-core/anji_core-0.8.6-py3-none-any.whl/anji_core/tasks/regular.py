...
from ..types import TaskStatus, Reaction, RenderFeatures, TimeseriesCompressPolicy, MessageType
...
class TaskManager(SecurityManager):
    ...
    def active_record_filter(cls) -> QueryAst:
        return RegularTask.status.one_of(TaskStatus.in_progress, TaskStatus.pending)
