...
__all__ = [
    'anji_orm_configuration', 'sentry_configuration', 'backgroun_task_configuration',
...
backgroun_task_configuration = Blueprint('Backgroun Task Configuration')  # pylint: disable=invalid-name
...
@backgroun_task_configuration.listener('before_server_start')
async def run_background_tasks(sanic_app, _loop: asyncio.AbstractEventLoop) -> None:
    sanic_app.tasks_list = []


@backgroun_task_configuration.listener('before_server_stop')
