...
def HawkesDeserialize(ptr: 'Hawkes', data: 'std::string const &') -> "void":
    ...
    return _hawkes_simulation.HawkesDeserialize(ptr, data)
...
def HawkesKernelExpDeserialize(ptr: 'HawkesKernelExp', data: 'std::string const &') -> "void":
    ...
    return _hawkes_simulation.HawkesKernelExpDeserialize(ptr, data)
...
def HawkesKernelSumExpDeserialize(ptr: 'HawkesKernelSumExp', data: 'std::string const &') -> "void":
    ...
    return _hawkes_simulation.HawkesKernelSumExpDeserialize(ptr, data)
...
def HawkesKernelPowerLawDeserialize(ptr: 'HawkesKernelPowerLaw', data: 'std::string const &') -> "void":
    ...
    return _hawkes_simulation.HawkesKernelPowerLawDeserialize(ptr, data)
...
def HawkesKernelTimeFuncDeserialize(ptr: 'HawkesKernelTimeFunc', data: 'std::string const &') -> "void":
    ...
    return _hawkes_simulation.HawkesKernelTimeFuncDeserialize(ptr, data)
...
def HawkesKernel0Deserialize(ptr: 'HawkesKernel0', data: 'std::string const &') -> "void":
    ...
    return _hawkes_simulation.HawkesKernel0Deserialize(ptr, data)
