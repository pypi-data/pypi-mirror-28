...
class ModelLabelsFeatures(Model):
    ...
    def __init__(self, features: 'SBaseArrayDouble2dPtr const', labels: 'SArrayDoublePtr const'):
        ...
        this = _hawkes_model.new_ModelLabelsFeatures(features, labels)
        try:
            self.this.append(this)
        except:
            self.this = this
    ...
    def get_n_samples(self) -> "unsigned long":
        ...
        return _hawkes_model.ModelLabelsFeatures_get_n_samples(self)


    def get_n_features(self) -> "unsigned long":
        """get_n_features(ModelLabelsFeatures self) -> unsigned long"""
        return _hawkes_model.ModelLabelsFeatures_get_n_features(self)

    __swig_destroy__ = _hawkes_model.delete_ModelLabelsFeatures
    __del__ = lambda self: None
ModelLabelsFeatures_swigregister = _hawkes_model.ModelLabelsFeatures_swigregister
...
class ModelGeneralizedLinear(ModelLabelsFeatures):
    ...
    def __init__(self, features: 'SBaseArrayDouble2dPtr const', labels: 'SArrayDoublePtr const', fit_intercept: 'bool const', n_threads: 'int const'=1):
        ...
        """
        this = _hawkes_model.new_ModelGeneralizedLinear(features, labels, fit_intercept, n_threads)
        try:
            self.this.append(this)
        except:
            self.this = this
    ...
    def get_n_coeffs(self) -> "unsigned long":
        ...
        return _hawkes_model.ModelGeneralizedLinear_get_n_coeffs(self)


    def set_fit_intercept(self, fit_intercept: 'bool') -> "void":
        """set_fit_intercept(ModelGeneralizedLinear self, bool fit_intercept)"""
        return _hawkes_model.ModelGeneralizedLinear_set_fit_intercept(self, fit_intercept)
    ...
    def sdca_primal_dual_relation(self, l_l2sq: 'double const', dual_vector: 'ArrayDouble const &', out_primal_vector: 'ArrayDouble &') -> "void":
        ...
        return _hawkes_model.ModelGeneralizedLinear_sdca_primal_dual_relation(self, l_l2sq, dual_vector, out_primal_vector)

    __swig_destroy__ = _hawkes_model.delete_ModelGeneralizedLinear
    __del__ = lambda self: None
ModelGeneralizedLinear_swigregister = _hawkes_model.ModelGeneralizedLinear_swigregister
...
def ModelHawkesExpKernLeastSqDeserialize(ptr: 'ModelHawkesExpKernLeastSq', data: 'std::string const &') -> "void":
    ...
    return _hawkes_model.ModelHawkesExpKernLeastSqDeserialize(ptr, data)
...
def ModelHawkesSumExpKernLeastSqDeserialize(ptr: 'ModelHawkesSumExpKernLeastSq', data: 'std::string const &') -> "void":
    ...
    return _hawkes_model.ModelHawkesSumExpKernLeastSqDeserialize(ptr, data)
