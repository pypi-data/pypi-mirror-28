...
class ModelLabelsFeatures(Model):
    ...
    def __init__(self, features: 'SBaseArrayDouble2dPtr const', labels: 'SArrayDoublePtr const'):
        ...
        this = _linear_model.new_ModelLabelsFeatures(features, labels)
        try:
            self.this.append(this)
        except:
            self.this = this
    ...
    def get_n_samples(self) -> "unsigned long":
        ...
        return _linear_model.ModelLabelsFeatures_get_n_samples(self)


    def get_n_features(self) -> "unsigned long":
        """get_n_features(ModelLabelsFeatures self) -> unsigned long"""
        return _linear_model.ModelLabelsFeatures_get_n_features(self)

    __swig_destroy__ = _linear_model.delete_ModelLabelsFeatures
    __del__ = lambda self: None
ModelLabelsFeatures_swigregister = _linear_model.ModelLabelsFeatures_swigregister
...
class ModelGeneralizedLinear(ModelLabelsFeatures):
    ...
    def __init__(self, features: 'SBaseArrayDouble2dPtr const', labels: 'SArrayDoublePtr const', fit_intercept: 'bool const', n_threads: 'int const'=1):
        ...
        """
        this = _linear_model.new_ModelGeneralizedLinear(features, labels, fit_intercept, n_threads)
        try:
            self.this.append(this)
        except:
            self.this = this
    ...
    def get_n_coeffs(self) -> "unsigned long":
        ...
        return _linear_model.ModelGeneralizedLinear_get_n_coeffs(self)


    def set_fit_intercept(self, fit_intercept: 'bool') -> "void":
        """set_fit_intercept(ModelGeneralizedLinear self, bool fit_intercept)"""
        return _linear_model.ModelGeneralizedLinear_set_fit_intercept(self, fit_intercept)
    ...
    def sdca_primal_dual_relation(self, l_l2sq: 'double const', dual_vector: 'ArrayDouble const &', out_primal_vector: 'ArrayDouble &') -> "void":
        ...
        return _linear_model.ModelGeneralizedLinear_sdca_primal_dual_relation(self, l_l2sq, dual_vector, out_primal_vector)

    __swig_destroy__ = _linear_model.delete_ModelGeneralizedLinear
    __del__ = lambda self: None
ModelGeneralizedLinear_swigregister = _linear_model.ModelGeneralizedLinear_swigregister
...
class ModelHinge(ModelGeneralizedLinear):
    ...
    def __init__(self, features: 'SBaseArrayDouble2dPtr const', labels: 'SArrayDoublePtr const', fit_intercept: 'bool const', n_threads: 'int const'):
        ...
        this = _linear_model.new_ModelHinge(features, labels, fit_intercept, n_threads)
        try:
            self.this.append(this)
        except:
            self.this = this
    __swig_destroy__ = _linear_model.delete_ModelHinge
    __del__ = lambda self: None
ModelHinge_swigregister = _linear_model.ModelHinge_swigregister
...
class ModelQuadraticHinge(ModelGeneralizedLinear, ModelLipschitz):
    ...
    def __init__(self, features: 'SBaseArrayDouble2dPtr const', labels: 'SArrayDoublePtr const', fit_intercept: 'bool const', n_threads: 'int const'):
        ...
        this = _linear_model.new_ModelQuadraticHinge(features, labels, fit_intercept, n_threads)
        try:
            self.this.append(this)
        except:
            self.this = this
    __swig_destroy__ = _linear_model.delete_ModelQuadraticHinge
    __del__ = lambda self: None
ModelQuadraticHinge_swigregister = _linear_model.ModelQuadraticHinge_swigregister
...
class ModelSmoothedHinge(ModelGeneralizedLinear, ModelLipschitz):
    ...
    def __init__(self, features: 'SBaseArrayDouble2dPtr const', labels: 'SArrayDoublePtr const', fit_intercept: 'bool const', smoothness: 'double const', n_threads: 'int const'):
        ...
        this = _linear_model.new_ModelSmoothedHinge(features, labels, fit_intercept, smoothness, n_threads)
        try:
            self.this.append(this)
        except:
            self.this = this
    ...
    def get_smoothness(self) -> "double":
        ...
        return _linear_model.ModelSmoothedHinge_get_smoothness(self)


    def set_smoothness(self, smoothness: 'double') -> "void":
        """set_smoothness(ModelSmoothedHinge self, double smoothness)"""
        return _linear_model.ModelSmoothedHinge_set_smoothness(self, smoothness)

    __swig_destroy__ = _linear_model.delete_ModelSmoothedHinge
    __del__ = lambda self: None
ModelSmoothedHinge_swigregister = _linear_model.ModelSmoothedHinge_swigregister
...
class ModelLinReg(ModelGeneralizedLinear, ModelLipschitz):
    ...
    def __init__(self, features: 'SBaseArrayDouble2dPtr const', labels: 'SArrayDoublePtr const', fit_intercept: 'bool const', n_threads: 'int const'):
        ...
        this = _linear_model.new_ModelLinReg(features, labels, fit_intercept, n_threads)
        try:
            self.this.append(this)
        except:
            self.this = this
    __swig_destroy__ = _linear_model.delete_ModelLinReg
    __del__ = lambda self: None
ModelLinReg_swigregister = _linear_model.ModelLinReg_swigregister
...
class ModelLogReg(ModelGeneralizedLinear, ModelLipschitz):
    ...
    def __init__(self, features: 'SBaseArrayDouble2dPtr const', labels: 'SArrayDoublePtr const', fit_intercept: 'bool const', n_threads: 'int const'):
        ...
        this = _linear_model.new_ModelLogReg(features, labels, fit_intercept, n_threads)
        try:
            self.this.append(this)
        except:
            self.this = this
    ...
    def sigmoid(x: 'ArrayDouble const &', out: 'ArrayDouble &') -> "void":
        ...
        return _linear_model.ModelLogReg_sigmoid(x, out)
    ...
    def logistic(x: 'ArrayDouble const &', out: 'ArrayDouble &') -> "void":
        ...
        return _linear_model.ModelLogReg_logistic(x, out)

    logistic = staticmethod(logistic)
    __swig_destroy__ = _linear_model.delete_ModelLogReg
    __del__ = lambda self: None
ModelLogReg_swigregister = _linear_model.ModelLogReg_swigregister
...
class ModelPoisReg(ModelGeneralizedLinear):
    ...
    def __init__(self, features: 'SBaseArrayDouble2dPtr const', labels: 'SArrayDoublePtr const', link_type: 'LinkType const', fit_intercept: 'bool const', n_threads: 'int const'):
        ...
        this = _linear_model.new_ModelPoisReg(features, labels, link_type, fit_intercept, n_threads)
        try:
            self.this.append(this)
        except:
            self.this = this
    ...
    def set_link_type(self, link_type: 'LinkType') -> "void":
        ...
        return _linear_model.ModelPoisReg_set_link_type(self, link_type)

    __swig_destroy__ = _linear_model.delete_ModelPoisReg
    __del__ = lambda self: None
ModelPoisReg_swigregister = _linear_model.ModelPoisReg_swigregister
