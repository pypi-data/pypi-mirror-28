...
import datetime
import calendar
from rejection.engines import RejectionEventException, IgnoreRejectionEngine
...
class DomainEvent(object):
    ...
    def __init__(self, name, id, data):
        ...
        self._id = id
        self._data = data
        self._version = calendar.timegm(datetime.datetime.utcnow().timetuple())
...
class AggregateRoot(object):
    ...
    def add_event(self, event):
        '''
        Añade y aplica un evento al root
        '''
