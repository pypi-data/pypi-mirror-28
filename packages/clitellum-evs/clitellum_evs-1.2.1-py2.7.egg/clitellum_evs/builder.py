...
"""
import sys
from repository import EvsRepository
from entities import AggregateRoot
from snapshot import SnapshotBuilder
from bson import ObjectId
from rejection.engines import IgnoreRejectionEngine, StopOnErrorRejectionEngine
...
class AggregateRootBuilder(object):
    ...
    def build(self):
        ...
        if entity is None:
            ...
            root = AggregateRoot(self._id, entity, machine, entity['state'], self._evs_repository, self._snapshot_builder)
