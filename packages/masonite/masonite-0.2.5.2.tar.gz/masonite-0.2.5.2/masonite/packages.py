...
def create_controller(location):
    ...
    if os.path.isfile(controller_file):
        print('\033[91mController Already Exists!\033[0m')
    else:
        ...
        project_controller = open(controller_file, "a")
        package_controller = open(location, 'r')

        project_controller.write(package_controller.read())

        project_controller.close()
        package_controller.close()
        print('\033[92mController Created\033[0m')
