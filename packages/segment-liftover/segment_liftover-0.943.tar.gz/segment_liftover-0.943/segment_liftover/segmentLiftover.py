...
#                 raise
        ...
        for index, row in df_mis.iterrows():
            unmapped_logger.info('{}\t{}\t{}\t{}\t{}\t{}'.format( row['chr_old'],
                row['position_old'], '-1', row['chr_cmp'], row[position_new], fin))
...
#            elif os.path.basename(f) == probe_input_file:
    ...
    print('Lifted (remapped) segments: {} ({})'.format(lifted_seg, remapped_seg))
    ...
    print('Lifted (remapped) probes: {} ({})'.format(lifted_pro, remapped_pro))
