...
class BuildTestData(object):
    ...
    def setup_environment_info(self,report_name,test_environment,browser,platform):
        try:
            ...
            env_setup="""%s</div> <div class="label-container"> <span class="label label-success" title="scenarios Passed: ">Passed: %s </span> &nbsp;&nbsp;<span class="label label-danger" title="scenarios Failed: ">Failed: %s </div> </div> </div> </div> <div class="container"> <div class="generated-on">%s</div> <div class="row"> <div class="chart col-lg-6 col-md-6"><br/><div class="GuageChart" id="chartdiv">&nbsp;</div> </div> <div class="chart col-lg-6 col-md-6" id="piechart_scenarios"> </div> </div> <div class="panel panel-default"> <div class="panel-heading"> <h4 class="panel-title"> <a data-toggle="collapse" href="#metadataInfo"> <i class="glyphicon glyphicon-chevron-right"></i> <i class="glyphicon glyphicon-chevron-down"></i> <b> Environment </b> </a> </h4> </div> <div id="metadataInfo" class="panel-collapse collapse"> <div class="panel-body"> <div class="row"> <div class="clearfix metadata col-xs-12 col-sm-6 col-md-6 col-lg-6"> <div class=pull-left> <strong> Data and Time: </strong>%s </div> </div> <div class="clearfix metadata col-xs-12 col-sm-6 col-md-6 col-lg-6"> <div class=pull-right-lg> <strong> Test Environment: </strong>%s </div> </div> <div class="clearfix metadata col-xs-12 col-sm-6 col-md-6 col-lg-6"> <div class=pull-left> <strong> Browser: </strong>%s</div> </div> <div class="clearfix metadata col-xs-12 col-sm-6 col-md-6 col-lg-6"> <div class=pull-right-lg> <strong> Platform: </strong>%s</div> </div>  </div> </div> </div> </div>"""%(report_name,passed_test,failed_test,date_and_time,execution_start_time,test_environment,browser,platform)
            return env_setup
        except Exception, ex:
    ...
    def add_failed_status_on_lable(self):
        pre_style_failed = """<div class="panel panel-default"> <div class="panel-heading" id="directory"> <h4 class="panel-title"> <a data-toggle="collapse" href="#collapseSuiteunhappy"> <i  class="glyphicon glyphicon-chevron-right"></i> <i class="glyphicon glyphicon-chevron-down"></i> <b>FAILED</b> <span   class="label-container"> <span  style="background-color:red" class="label label-success" title="Failed">%s</span> </span> </a> </h4> </div> <div id="collapseSuiteunhappy" class="panel-collapse collapse"> <div class="panel-body"> <div class="row">  <div class="panel-body">"""%(self.total_failed)
    ...
    def generate_final_report(self):
        ...
        file_name = os.path.abspath(self.file_path+"/report.html")
        try:
...
class Report(object):
    ...
    def start(self,file_path,report_name,test_environment,browser_version):
