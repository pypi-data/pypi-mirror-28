        ...
        if files:
            for file_id in files:
                try:
                    ...
                    file_instance.attach(serializer.instance)
                except File.DoesNotExist:
                    pass
        if entrepreneurs:
            serializer.instance.entrepreneurs.clear()
            for entrepreneur_id in entrepreneurs:
                try:
                    entrepreneur = Entrepreneur.objects.get(pk=entrepreneur_id)
                    EntrepreneurHasEnterprise.objects.create(
                        entrepreneur=entrepreneur,
                        enterprise=serializer.instance
                    )
