...
name    = "banks"
version = "2018-01-25T1729Z"

#def refresh_access_Monzo(
#    filepath_credentials = "~/.monzo"
#    ):
#
...
def transactions_DataFrame_Monzo(
    ...
    account_code = credentials["account_ID"]
    token        = credentials["access_token"]
    # API
    URL      = "https://api.monzo.com//transactions?expand[]=merchant&account_id=" + account_code
    ...
    for transaction in response["transactions"]:
        try:
            # Monzo-to-Monzo transactions do not appear to have account number
            # and sort code data.
            try:
...
def payment_in_transactions_Monzo(
    ...
    return payment_in_transactions(
        df          = transactions_DataFrame_Monzo(filepath_credentials = filepath_credentials),
        reference   = reference,
        amount      = amount,
