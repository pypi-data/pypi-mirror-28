...
class Group(object):
  ...
  def send_command(self, group_command):
    ...
    :param group_command: A GroupCommand instance
    :return:
    """
  ...
  def send_feedback_request(self):
    ...
    *get_next_feedback* (any previously returned data is discarded).
    """
  ...
  def get_next_feedback(self, timeout_ms=None, reuse_fbk=None):
    ...
    frequency with set_feedback_frequency.
...
class GroupDelegate(UnmanagedObject):
  ...
  def __init__(self, internal):
    ...
    self._number_of_modules = hebiGroupGetSize(internal)
  ...
  @property
  def feedback_frequency(self):
    return hebiGroupGetFeedbackFrequencyHz(self)
  ...
  @property
  def command_lifetime(self):
    return hebiGroupGetCommandLifetime(self)
