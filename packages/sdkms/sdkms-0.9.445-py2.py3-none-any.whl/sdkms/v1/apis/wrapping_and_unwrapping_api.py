...
class WrappingAndUnwrappingApi(object):
    ...
    def unwrap_key(self, key_id, body, async=False, **kwargs):
        ...
        if kwargs.get('async'):
            return self.unwrap_key_with_http_info(key_id, body, **kwargs)
        else:
            (data) = self.unwrap_key_with_http_info(key_id, body, **kwargs)
            return data
    ...
    def unwrap_key_ex(self, body, async=False, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.unwrap_key_ex_with_http_info(body, **kwargs)
        else:
            (data) = self.unwrap_key_ex_with_http_info(body, **kwargs)
            return data
    ...
    def wrap_key(self, key_id, body, async=False, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.wrap_key_with_http_info(key_id, body, **kwargs)
        else:
            (data) = self.wrap_key_with_http_info(key_id, body, **kwargs)
            return data
    ...
    def wrap_key_ex(self, body, async=False, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.wrap_key_ex_with_http_info(body, **kwargs)
        else:
            (data) = self.wrap_key_ex_with_http_info(body, **kwargs)
            return data
