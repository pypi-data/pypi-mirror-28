...
class SignAndVerifyApi(object):
    ...
    def batch_sign(self, body, async=False, **kwargs):
        ...
        if kwargs.get('async'):
            return self.batch_sign_with_http_info(body, **kwargs)
        else:
            (data) = self.batch_sign_with_http_info(body, **kwargs)
            return data
    ...
    def batch_verify(self, body, async=False, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.batch_verify_with_http_info(body, **kwargs)
        else:
            (data) = self.batch_verify_with_http_info(body, **kwargs)
            return data
    ...
    def sign(self, key_id, body, async=False, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.sign_with_http_info(key_id, body, **kwargs)
        else:
            (data) = self.sign_with_http_info(key_id, body, **kwargs)
            return data
    ...
    def sign_ex(self, body, async=False, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.sign_ex_with_http_info(body, **kwargs)
        else:
            (data) = self.sign_ex_with_http_info(body, **kwargs)
            return data
    ...
    def verify(self, key_id, body, async=False, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.verify_with_http_info(key_id, body, **kwargs)
        else:
            (data) = self.verify_with_http_info(key_id, body, **kwargs)
            return data
    ...
    def verify_ex(self, body, async=False, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.verify_ex_with_http_info(body, **kwargs)
        else:
            (data) = self.verify_ex_with_http_info(body, **kwargs)
            return data
