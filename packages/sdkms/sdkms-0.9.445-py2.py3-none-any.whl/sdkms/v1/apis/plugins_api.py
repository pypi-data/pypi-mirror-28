...
class PluginsApi(object):
    ...
    def create_plugin(self, body, async=False, **kwargs):
        ...
        if kwargs.get('async'):
            return self.create_plugin_with_http_info(body, **kwargs)
        else:
            (data) = self.create_plugin_with_http_info(body, **kwargs)
            return data
    ...
    def delete_plugin(self, plugin_id, async=False, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.delete_plugin_with_http_info(plugin_id, **kwargs)
        else:
            (data) = self.delete_plugin_with_http_info(plugin_id, **kwargs)
            return data
    ...
    def get_plugin(self, plugin_id, async=False, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.get_plugin_with_http_info(plugin_id, **kwargs)
        else:
            (data) = self.get_plugin_with_http_info(plugin_id, **kwargs)
            return data
    ...
    def update_plugin(self, plugin_id, body, async=False, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.update_plugin_with_http_info(plugin_id, body, **kwargs)
        else:
            (data) = self.update_plugin_with_http_info(plugin_id, body, **kwargs)
            return data
