...
class TwoFactorAuthenticationApi(object):
    ...
    def authorize_recovery_code(self, async=False, **kwargs):
        ...
        if kwargs.get('async'):
            return self.authorize_recovery_code_with_http_info(**kwargs)
        else:
            (data) = self.authorize_recovery_code_with_http_info(**kwargs)
            return data
    ...
    def authorize_u2_f(self, async=False, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.authorize_u2_f_with_http_info(**kwargs)
        else:
            (data) = self.authorize_u2_f_with_http_info(**kwargs)
            return data
    ...
    def generate_recovery_codes(self, async=False, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.generate_recovery_codes_with_http_info(**kwargs)
        else:
            (data) = self.generate_recovery_codes_with_http_info(**kwargs)
            return data
    ...
    def generate_u2_f_challenge(self, async=False, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.generate_u2_f_challenge_with_http_info(**kwargs)
        else:
            (data) = self.generate_u2_f_challenge_with_http_info(**kwargs)
            return data
    ...
    def lock2_f(self, async=False, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.lock2_f_with_http_info(**kwargs)
        else:
            (data) = self.lock2_f_with_http_info(**kwargs)
            return data
