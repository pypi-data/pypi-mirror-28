...
class AuthenticationApi(object):
    ...
    def authorize(self, async=False, **kwargs):
        ...
        if kwargs.get('async'):
            return self.authorize_with_http_info(**kwargs)
        else:
            (data) = self.authorize_with_http_info(**kwargs)
            return data
    ...
    def get_server_version(self, async=False, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.get_server_version_with_http_info(**kwargs)
        else:
            (data) = self.get_server_version_with_http_info(**kwargs)
            return data
    ...
    def select_account(self, body, async=False, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.select_account_with_http_info(body, **kwargs)
        else:
            (data) = self.select_account_with_http_info(body, **kwargs)
            return data
    ...
    def terminate(self, async=False, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.terminate_with_http_info(**kwargs)
        else:
            (data) = self.terminate_with_http_info(**kwargs)
            return data
    ...
    def unlock2_f(self, async=False, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.unlock2_f_with_http_info(**kwargs)
        else:
            (data) = self.unlock2_f_with_http_info(**kwargs)
            return data
