...
class DigestApi(object):
    ...
    def compute_digest(self, body, async=False, **kwargs):
        ...
        if kwargs.get('async'):
            return self.compute_digest_with_http_info(body, **kwargs)
        else:
            (data) = self.compute_digest_with_http_info(body, **kwargs)
            return data
    ...
    def compute_mac(self, key_id, body, async=False, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.compute_mac_with_http_info(key_id, body, **kwargs)
        else:
            (data) = self.compute_mac_with_http_info(key_id, body, **kwargs)
            return data
    ...
    def compute_mac_ex(self, body, async=False, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.compute_mac_ex_with_http_info(body, **kwargs)
        else:
            (data) = self.compute_mac_ex_with_http_info(body, **kwargs)
            return data
    ...
    def verify_mac(self, key_id, body, async=False, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.verify_mac_with_http_info(key_id, body, **kwargs)
        else:
            (data) = self.verify_mac_with_http_info(key_id, body, **kwargs)
            return data
    ...
    def verify_mac_ex(self, body, async=False, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.verify_mac_ex_with_http_info(body, **kwargs)
        else:
            (data) = self.verify_mac_ex_with_http_info(body, **kwargs)
            return data
