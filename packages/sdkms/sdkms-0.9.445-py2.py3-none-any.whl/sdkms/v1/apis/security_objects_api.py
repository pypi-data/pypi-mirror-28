...
class SecurityObjectsApi(object):
    ...
    def agree_key(self, body, async=False, **kwargs):
        ...
        if kwargs.get('async'):
            return self.agree_key_with_http_info(body, **kwargs)
        else:
            (data) = self.agree_key_with_http_info(body, **kwargs)
            return data
    ...
    def delete_private_key(self, key_id, async=False, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.delete_private_key_with_http_info(key_id, **kwargs)
        else:
            (data) = self.delete_private_key_with_http_info(key_id, **kwargs)
            return data
    ...
    def delete_security_object(self, key_id, async=False, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.delete_security_object_with_http_info(key_id, **kwargs)
        else:
            (data) = self.delete_security_object_with_http_info(key_id, **kwargs)
            return data
    ...
    def derive_key(self, key_id, body, async=False, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.derive_key_with_http_info(key_id, body, **kwargs)
        else:
            (data) = self.derive_key_with_http_info(key_id, body, **kwargs)
            return data
    ...
    def derive_key_ex(self, body, async=False, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.derive_key_ex_with_http_info(body, **kwargs)
        else:
            (data) = self.derive_key_ex_with_http_info(body, **kwargs)
            return data
    ...
    def generate_security_object(self, body, async=False, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.generate_security_object_with_http_info(body, **kwargs)
        else:
            (data) = self.generate_security_object_with_http_info(body, **kwargs)
            return data
    ...
    def get_security_object(self, key_id, async=False, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.get_security_object_with_http_info(key_id, **kwargs)
        else:
            (data) = self.get_security_object_with_http_info(key_id, **kwargs)
            return data
    ...
    def get_security_object_value(self, key_id, async=False, **kwargs):
        """
        Get the details and value of a particular secret security object. 
        @type async: bool
        @param async: Whether the call should be performed asynchronously. (Default is False).
        @type key_id: L{str}
        @param key_id: kid of security object (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.get_security_object_value_with_http_info(key_id, **kwargs)
        else:
            (data) = self.get_security_object_value_with_http_info(key_id, **kwargs)
            return data
    ...
    def get_security_objects(self, name=None, group_id=None, creator=None, sort=None, start=None, limit=None, offset=None, async=False, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.get_security_objects_with_http_info(**kwargs)
        else:
            (data) = self.get_security_objects_with_http_info(**kwargs)
            return data
    ...
    def import_security_object(self, body, async=False, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.import_security_object_with_http_info(body, **kwargs)
        else:
            (data) = self.import_security_object_with_http_info(body, **kwargs)
            return data
    ...
    def persist_security_object(self, body, async=False, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.persist_security_object_with_http_info(body, **kwargs)
        else:
            (data) = self.persist_security_object_with_http_info(body, **kwargs)
            return data
    ...
    def update_security_object(self, key_id, body, async=False, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.update_security_object_with_http_info(key_id, body, **kwargs)
        else:
            (data) = self.update_security_object_with_http_info(key_id, body, **kwargs)
            return data
