...
class AuthConfigPassword(object):
    ...
    def require_2fa(self, require_2fa):
        ...
        if require_2fa is None:
            raise ValueError("Invalid value for `require_2fa`, must not be `None`")
    ...
    def administrators_only(self, administrators_only):
        ...
        Reserved for future use, must be false.
        """
        if administrators_only is None:
            raise ValueError("Invalid value for `administrators_only`, must not be `None`")
