...
class Plugin(object):
    ...
    def default_group(self, default_group):
        ...
        if default_group is None:
            raise ValueError("Invalid value for `default_group`, must not be `None`")
    ...
    def plugin_type(self, plugin_type):
        ...
        if plugin_type is None:
            raise ValueError("Invalid value for `plugin_type`, must not be `None`")
    ...
    def lastrun_at(self, lastrun_at):
        ...
        When this plugin was last run.
        """
        if lastrun_at is None:
            raise ValueError("Invalid value for `lastrun_at`, must not be `None`")
    ...
    def lastupdated_at(self, lastupdated_at):
        ...
        When this plugin was last updated.
        """
        if lastupdated_at is None:
            raise ValueError("Invalid value for `lastupdated_at`, must not be `None`")
