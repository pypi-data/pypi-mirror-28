...
class KeyObject(object):
    ...
    def lastused_at(self, lastused_at):
        ...
        When this security object was last used.
        """
        if lastused_at is None:
            raise ValueError("Invalid value for `lastused_at`, must not be `None`")
    ...
    def never_exportable(self, never_exportable):
        ...
        True if this key's operations have never contained EXPORT.
        """
        if never_exportable is None:
            raise ValueError("Invalid value for `never_exportable`, must not be `None`")
