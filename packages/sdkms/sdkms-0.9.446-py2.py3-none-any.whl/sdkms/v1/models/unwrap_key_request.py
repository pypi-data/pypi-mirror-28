...
class UnwrapKeyRequest(object):
    ...
    def __init__(self, alg=None, group_id=None, obj_type=None, wrapped_key=None, mode=None, iv=None, ad=None, tag=None, name=None, description=None, key_ops=None, custom_metadata=None, enabled=None, transient=None):
        """
    ...
    def wrapped_key(self, wrapped_key):
        ...
        if wrapped_key is None:
            raise ValueError("Invalid value for `wrapped_key`, must not be `None`")
