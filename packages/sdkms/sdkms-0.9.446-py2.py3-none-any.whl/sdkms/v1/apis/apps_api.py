...
class AppsApi(object):
    ...
    def create_app(self, body, async=False, **kwargs):
        ...
        if kwargs.get('async'):
            return self.create_app_with_http_info(body, **kwargs)
        else:
            (data) = self.create_app_with_http_info(body, **kwargs)
            return data
    ...
    def get_credential(self, app_id, async=False, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.get_credential_with_http_info(app_id, **kwargs)
        else:
            (data) = self.get_credential_with_http_info(app_id, **kwargs)
            return data
    ...
    def regenerate_api_key(self, app_id, async=False, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.regenerate_api_key_with_http_info(app_id, **kwargs)
        else:
            (data) = self.regenerate_api_key_with_http_info(app_id, **kwargs)
            return data
    ...
    def update_app(self, app_id, body, async=False, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.update_app_with_http_info(app_id, body, **kwargs)
        else:
            (data) = self.update_app_with_http_info(app_id, body, **kwargs)
            return data
