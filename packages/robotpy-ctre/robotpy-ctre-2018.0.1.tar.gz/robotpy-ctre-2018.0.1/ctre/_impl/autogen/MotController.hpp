...
public:
  void create1(int baseArbId) {
    m_handle = c_MotController_Create1(baseArbId);
  }

  std::tuple<ctre::phoenix::ErrorCode, int> getDeviceNumber() {
    int deviceNumber;
    auto __ret =  c_MotController_GetDeviceNumber(m_handle, &deviceNumber );
    return std::make_tuple(__ret, deviceNumber);
  }
  ...
  std::tuple<ctre::phoenix::ErrorCode, double> getBusVoltage() {
    double voltage;
    auto __ret =  c_MotController_GetBusVoltage(m_handle, &voltage );
    return std::make_tuple(__ret, voltage);
  }


  std::tuple<ctre::phoenix::ErrorCode, double> getMotorOutputPercent() {
    double percentOutput;
    auto __ret =  c_MotController_GetMotorOutputPercent(m_handle, &percentOutput );
    return std::make_tuple(__ret, percentOutput);
  }


  std::tuple<ctre::phoenix::ErrorCode, double> getOutputCurrent() {
    double current;
    auto __ret =  c_MotController_GetOutputCurrent(m_handle, &current );
    return std::make_tuple(__ret, current);
  }


  std::tuple<ctre::phoenix::ErrorCode, double> getTemperature() {
    double temperature;
    auto __ret =  c_MotController_GetTemperature(m_handle, &temperature );
    return std::make_tuple(__ret, temperature);
  }
  ...
  std::tuple<ctre::phoenix::ErrorCode, int> getSelectedSensorPosition(int pidIdx) {
    int param;
    auto __ret =  c_MotController_GetSelectedSensorPosition(m_handle, &param, pidIdx );
    return std::make_tuple(__ret, param);
  }


  std::tuple<ctre::phoenix::ErrorCode, int> getSelectedSensorVelocity(int pidIdx) {
    int param;
    auto __ret =  c_MotController_GetSelectedSensorVelocity(m_handle, &param, pidIdx );
    return std::make_tuple(__ret, param);
  }
  ...
  std::tuple<ctre::phoenix::ErrorCode, int> getStatusFramePeriod(int frame, int timeoutMs) {
    int periodMs;
    auto __ret =  c_MotController_GetStatusFramePeriod(m_handle, frame, &periodMs, timeoutMs );
  ...
  std::tuple<ctre::phoenix::ErrorCode, int> getClosedLoopError(int pidIdx) {
    int closedLoopError;
    auto __ret =  c_MotController_GetClosedLoopError(m_handle, &closedLoopError, pidIdx );
    return std::make_tuple(__ret, closedLoopError);
  }


  std::tuple<ctre::phoenix::ErrorCode, double> getIntegralAccumulator(int pidIdx) {
    double iaccum;
    auto __ret =  c_MotController_GetIntegralAccumulator(m_handle, &iaccum, pidIdx );
    return std::make_tuple(__ret, iaccum);
  }


  std::tuple<ctre::phoenix::ErrorCode, double> getErrorDerivative(int pidIdx) {
    double derror;
    auto __ret =  c_MotController_GetErrorDerivative(m_handle, &derror, pidIdx );
    return std::make_tuple(__ret, derror);
  }
  ...
  std::tuple<ctre::phoenix::ErrorCode, int> getActiveTrajectoryPosition() {
    int param;
    auto __ret =  c_MotController_GetActiveTrajectoryPosition(m_handle, &param );
    return std::make_tuple(__ret, param);
  }


  std::tuple<ctre::phoenix::ErrorCode, int> getActiveTrajectoryVelocity() {
    int param;
    auto __ret =  c_MotController_GetActiveTrajectoryVelocity(m_handle, &param );
    return std::make_tuple(__ret, param);
  }


  std::tuple<ctre::phoenix::ErrorCode, double> getActiveTrajectoryHeading() {
    double param;
    auto __ret =  c_MotController_GetActiveTrajectoryHeading(m_handle, &param );
    return std::make_tuple(__ret, param);
  }


  std::tuple<ctre::phoenix::ErrorCode, int, int, double> getActiveTrajectoryAll() {
    int vel;int pos;double heading;
    auto __ret =  c_MotController_GetActiveTrajectoryAll(m_handle, &vel, &pos, &heading );
    return std::make_tuple(__ret, vel, pos, heading);
  }
  ...
  std::tuple<ctre::phoenix::ErrorCode, int> getMotionProfileTopLevelBufferCount() {
    int value;
    auto __ret =  c_MotController_GetMotionProfileTopLevelBufferCount(m_handle, &value );
    return std::make_tuple(__ret, value);
  }


  ctre::phoenix::ErrorCode pushMotionProfileTrajectory(double position, double velocity, double headingDeg, int profileSlotSelect, bool isLastPoint, bool zeroPos) {
  ...
  ctre::phoenix::ErrorCode pushMotionProfileTrajectory_2(double position, double velocity, double headingDeg, int profileSlotSelect0, int profileSlotSelect1, bool isLastPoint, bool zeroPos, int durationMs) {
  ...
  std::tuple<ctre::phoenix::ErrorCode, bool> isMotionProfileTopLevelBufferFull() {
    bool value;
    auto __ret =  c_MotController_IsMotionProfileTopLevelBufferFull(m_handle, &value );
    return std::make_tuple(__ret, value);
  }
  ...
  std::tuple<ctre::phoenix::ErrorCode, int, int, int, bool, bool, bool, bool, int, int> getMotionProfileStatus() {
    ...
    auto __ret =  c_MotController_GetMotionProfileStatus(m_handle, &topBufferRem, &topBufferCnt, &btmBufferCnt, &hasUnderrun, &isUnderrun, &activePointValid, &isLast, &profileSlotSelect, &outputEnable );
    return std::make_tuple(__ret, topBufferRem, topBufferCnt, btmBufferCnt, hasUnderrun, isUnderrun, activePointValid, isLast, profileSlotSelect, outputEnable);
  }


  std::tuple<ctre::phoenix::ErrorCode, int, int, int, bool, bool, bool, bool, int, int, int, int> getMotionProfileStatus_2() {
    ...
    auto __ret =  c_MotController_GetMotionProfileStatus_2(m_handle, &topBufferRem, &topBufferCnt, &btmBufferCnt, &hasUnderrun, &isUnderrun, &activePointValid, &isLast, &profileSlotSelect, &outputEnable, &timeDurMs, &profileSlotSelect1 );
    return std::make_tuple(__ret, topBufferRem, topBufferCnt, btmBufferCnt, hasUnderrun, isUnderrun, activePointValid, isLast, profileSlotSelect, outputEnable, timeDurMs, profileSlotSelect1);
  }
  ...
  std::tuple<ctre::phoenix::ErrorCode, int> getFirmwareVersion() {
    int param0;
    auto __ret =  c_MotController_GetFirmwareVersion(m_handle, &param0 );
    return std::make_tuple(__ret, param0);
  }


  std::tuple<ctre::phoenix::ErrorCode, bool> hasResetOccurred() {
    bool param0;
    auto __ret =  c_MotController_HasResetOccurred(m_handle, &param0 );
    return std::make_tuple(__ret, param0);
  }
  ...
  std::tuple<ctre::phoenix::ErrorCode, int> configGetCustomParam(int paramIndex, int timoutMs) {
    int readValue;
    auto __ret =  c_MotController_ConfigGetCustomParam(m_handle, &readValue, paramIndex, timoutMs );
  ...
  std::tuple<ctre::phoenix::ErrorCode, double> configGetParameter(int param, int ordinal, int timeoutMs) {
    double value;
    auto __ret =  c_MotController_ConfigGetParameter(m_handle, param, &value, ordinal, timeoutMs );
    return std::make_tuple(__ret, value);
  }
  ...
  std::tuple<ctre::phoenix::ErrorCode, int> getAnalogIn() {
    int param;
    auto __ret =  c_MotController_GetAnalogIn(m_handle, &param );
    return std::make_tuple(__ret, param);
  }
  ...
  std::tuple<ctre::phoenix::ErrorCode, int> getAnalogInRaw() {
    int param;
    auto __ret =  c_MotController_GetAnalogInRaw(m_handle, &param );
    return std::make_tuple(__ret, param);
  }


  std::tuple<ctre::phoenix::ErrorCode, int> getAnalogInVel() {
    int param;
    auto __ret =  c_MotController_GetAnalogInVel(m_handle, &param );
    return std::make_tuple(__ret, param);
  }


  std::tuple<ctre::phoenix::ErrorCode, int> getQuadraturePosition() {
    int param;
    auto __ret =  c_MotController_GetQuadraturePosition(m_handle, &param );
    return std::make_tuple(__ret, param);
  }
  ...
  std::tuple<ctre::phoenix::ErrorCode, int> getQuadratureVelocity() {
    int param;
    auto __ret =  c_MotController_GetQuadratureVelocity(m_handle, &param );
    return std::make_tuple(__ret, param);
  }


  std::tuple<ctre::phoenix::ErrorCode, int> getPulseWidthPosition() {
    int param;
    auto __ret =  c_MotController_GetPulseWidthPosition(m_handle, &param );
    return std::make_tuple(__ret, param);
  }
  ...
  std::tuple<ctre::phoenix::ErrorCode, int> getPulseWidthVelocity() {
    int param;
    auto __ret =  c_MotController_GetPulseWidthVelocity(m_handle, &param );
    return std::make_tuple(__ret, param);
  }


  std::tuple<ctre::phoenix::ErrorCode, int> getPulseWidthRiseToFallUs() {
    int param;
    auto __ret =  c_MotController_GetPulseWidthRiseToFallUs(m_handle, &param );
    return std::make_tuple(__ret, param);
  }


  std::tuple<ctre::phoenix::ErrorCode, int> getPulseWidthRiseToRiseUs() {
    int param;
    auto __ret =  c_MotController_GetPulseWidthRiseToRiseUs(m_handle, &param );
    return std::make_tuple(__ret, param);
  }


  std::tuple<ctre::phoenix::ErrorCode, int> getPinStateQuadA() {
    int param;
    auto __ret =  c_MotController_GetPinStateQuadA(m_handle, &param );
    return std::make_tuple(__ret, param);
  }


  std::tuple<ctre::phoenix::ErrorCode, int> getPinStateQuadB() {
    int param;
    auto __ret =  c_MotController_GetPinStateQuadB(m_handle, &param );
    return std::make_tuple(__ret, param);
  }


  std::tuple<ctre::phoenix::ErrorCode, int> getPinStateQuadIdx() {
    int param;
    auto __ret =  c_MotController_GetPinStateQuadIdx(m_handle, &param );
    return std::make_tuple(__ret, param);
  }


  std::tuple<ctre::phoenix::ErrorCode, int> isFwdLimitSwitchClosed() {
    int param;
    auto __ret =  c_MotController_IsFwdLimitSwitchClosed(m_handle, &param );
    return std::make_tuple(__ret, param);
  }


  std::tuple<ctre::phoenix::ErrorCode, int> isRevLimitSwitchClosed() {
    int param;
    auto __ret =  c_MotController_IsRevLimitSwitchClosed(m_handle, &param );
    return std::make_tuple(__ret, param);
  }
  ...
  std::tuple<ctre::phoenix::ErrorCode, int> getFaults() {
    int param;
    auto __ret =  c_MotController_GetFaults(m_handle, &param );
    return std::make_tuple(__ret, param);
  }
  ...
  std::tuple<ctre::phoenix::ErrorCode, int> getStickyFaults() {
    int param;
    auto __ret =  c_MotController_GetStickyFaults(m_handle, &param );
    return std::make_tuple(__ret, param);
  }
  ...
  std::tuple<ctre::phoenix::ErrorCode, int, int, int> getAnalogInAll() {
    int withOv;int raw;int vel;
    auto __ret =  c_MotController_GetAnalogInAll(m_handle, &withOv, &raw, &vel );
    return std::make_tuple(__ret, withOv, raw, vel);
  }


  std::tuple<ctre::phoenix::ErrorCode, int, int> getQuadratureSensor() {
    int pos;int vel;
    auto __ret =  c_MotController_GetQuadratureSensor(m_handle, &pos, &vel );
    return std::make_tuple(__ret, pos, vel);
  }


  std::tuple<ctre::phoenix::ErrorCode, int, int, int, int> getPulseWidthAll() {
    int pos;int vel;int riseToRiseUs;int riseToFallUs;
    auto __ret =  c_MotController_GetPulseWidthAll(m_handle, &pos, &vel, &riseToRiseUs, &riseToFallUs );
    return std::make_tuple(__ret, pos, vel, riseToRiseUs, riseToFallUs);
  }


  std::tuple<ctre::phoenix::ErrorCode, int, int, int> getQuadPinStates() {
    int quadA;int quadB;int quadIdx;
    auto __ret =  c_MotController_GetQuadPinStates(m_handle, &quadA, &quadB, &quadIdx );
    return std::make_tuple(__ret, quadA, quadB, quadIdx);
  }


  std::tuple<ctre::phoenix::ErrorCode, int, int> getLimitSwitchState() {
    int isFwdClosed;int isRevClosed;
    auto __ret =  c_MotController_GetLimitSwitchState(m_handle, &isFwdClosed, &isRevClosed );
    return std::make_tuple(__ret, isFwdClosed, isRevClosed);
  }


  std::tuple<ctre::phoenix::ErrorCode, int> getClosedLoopTarget(int pidIdx) {
    int value;
    auto __ret =  c_MotController_GetClosedLoopTarget(m_handle, &value, pidIdx );
    return std::make_tuple(__ret, value);
  }
