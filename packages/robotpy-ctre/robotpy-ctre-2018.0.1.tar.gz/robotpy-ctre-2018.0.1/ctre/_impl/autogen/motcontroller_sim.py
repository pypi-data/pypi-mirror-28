...
class MotController:
    ...
    def create1(self, baseArbId: int) -> None:
        assert isinstance(baseArbId, int)
        self.create_called = True

    def getDeviceNumber(self) -> typing.Tuple[int, int]:
    ...
    def getMotorOutputPercent(self) -> typing.Tuple[int, float]:
    ...
    def getOutputCurrent(self) -> typing.Tuple[int, float]:
    ...
    def getTemperature(self) -> typing.Tuple[int, float]:
    ...
    def getSelectedSensorPosition(self, pidIdx: int) -> typing.Tuple[int, int]:
    ...
    def getSelectedSensorVelocity(self, pidIdx: int) -> typing.Tuple[int, int]:
    ...
    def getClosedLoopError(self, pidIdx: int) -> typing.Tuple[int, int]:
    ...
    def getIntegralAccumulator(self, pidIdx: int) -> typing.Tuple[int, float]:
    ...
    def getErrorDerivative(self, pidIdx: int) -> typing.Tuple[int, float]:
    ...
    def getActiveTrajectoryPosition(self) -> typing.Tuple[int, int]:
    ...
    def getActiveTrajectoryVelocity(self) -> typing.Tuple[int, int]:
    ...
    def getActiveTrajectoryHeading(self) -> typing.Tuple[int, float]:
    ...
    def getActiveTrajectoryAll(self) -> typing.Tuple[int, int, int, float]:
        raise NotImplementedError
    ...
    def getMotionProfileTopLevelBufferCount(self) -> typing.Tuple[int, int]:
    ...
    def pushMotionProfileTrajectory(self, position: float, velocity: float, headingDeg: float, profileSlotSelect: int, isLastPoint: bool, zeroPos: bool) -> int:
    ...
    def pushMotionProfileTrajectory_2(self, position: float, velocity: float, headingDeg: float, profileSlotSelect0: int, profileSlotSelect1: int, isLastPoint: bool, zeroPos: bool, durationMs: int) -> int:
        assert isinstance(position, (int, float))
        assert isinstance(velocity, (int, float))
        assert isinstance(headingDeg, (int, float))
    ...
    def isMotionProfileTopLevelBufferFull(self) -> typing.Tuple[int, bool]:
    ...
    def getMotionProfileStatus(self) -> typing.Tuple[int, int, int, int, bool, bool, bool, bool, int, int]:
    ...
    def getMotionProfileStatus_2(self) -> typing.Tuple[int, int, int, int, bool, bool, bool, bool, int, int, int, int]:
        raise NotImplementedError
    ...
    def getAnalogIn(self) -> typing.Tuple[int, int]:
    ...
    def getAnalogInRaw(self) -> typing.Tuple[int, int]:
        '''Get the position of whatever is in the analog pin of the Talon,
        regardless of whether it is actually being used for feedback.
    ...
    def getAnalogInVel(self) -> typing.Tuple[int, int]:
    ...
    def getQuadraturePosition(self) -> typing.Tuple[int, int]:
    ...
    def getQuadratureVelocity(self) -> typing.Tuple[int, int]:
    ...
    def getPulseWidthPosition(self) -> typing.Tuple[int, int]:
    ...
    def getPulseWidthVelocity(self) -> typing.Tuple[int, int]:
    ...
    def getPulseWidthRiseToFallUs(self) -> typing.Tuple[int, int]:
    ...
    def getPulseWidthRiseToRiseUs(self) -> typing.Tuple[int, int]:
    ...
    def getPinStateQuadA(self) -> typing.Tuple[int, int]:
        '''
        '''
        raise NotImplementedError

    def getPinStateQuadB(self) -> typing.Tuple[int, int]:
        raise NotImplementedError

    def getPinStateQuadIdx(self) -> typing.Tuple[int, int]:
        raise NotImplementedError

    def isFwdLimitSwitchClosed(self) -> typing.Tuple[int, int]:
        raise NotImplementedError

    def isRevLimitSwitchClosed(self) -> typing.Tuple[int, int]:
        raise NotImplementedError
    ...
    def getAnalogInAll(self) -> typing.Tuple[int, int, int, int]:
        raise NotImplementedError

    def getQuadratureSensor(self) -> typing.Tuple[int, int, int]:
        raise NotImplementedError

    def getPulseWidthAll(self) -> typing.Tuple[int, int, int, int, int]:
        raise NotImplementedError

    def getQuadPinStates(self) -> typing.Tuple[int, int, int, int]:
        raise NotImplementedError

    def getLimitSwitchState(self) -> typing.Tuple[int, int, int]:
        raise NotImplementedError

    def getClosedLoopTarget(self, pidIdx: int) -> typing.Tuple[int, int]:
        '''Gets the closed-loop error. The units depend on which control mode is in
        use. See Phoenix-Documentation information on units.
