...
class Repo(BaseRepo):
    ...
    def gen_upload_request(self, fs_paths, embedded, file_not_found_callback=None):
        ...
        for fs_path in fs_paths:
            ...
            try:
                ...
                if file_not_found_callback is not None:
                    file_not_found_callback(tree_path)

    def _build_stage_files(self, fs_paths, index, embedded):
        def on_file_not_found(tree_path):
        ...
        for upload_request in self.gen_upload_request(fs_paths, embedded, on_file_not_found):
            yield upload_request

    def stage(self, fs_paths, embedded, callback=None):
        ...
        self._upload_staged_files(files_to_add, callback=callback)
