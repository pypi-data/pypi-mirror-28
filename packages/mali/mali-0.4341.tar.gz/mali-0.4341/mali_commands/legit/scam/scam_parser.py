...
class SQLQueryBuilder(LuceneTreeVisitorV2):
    ...
    def _func_seed(self, node):
        self.__vars['seed'] = int(str(node.expr))

    def _func_group(self, node):
