...
def do_upload(auth, bucket_name, object_name, full_path_to_data, headers, head_url, put_url, credentials=None, callback=None):
    ...
    @retry(retry_on_exception=__retry_if_retry_possible_error, wait_exponential_multiplier=50, wait_exponential_max=5000)
    def with_retry_s3():
    ...
    with closing_with_condition(file_obj, should_close):
        with_retry_gcs()
