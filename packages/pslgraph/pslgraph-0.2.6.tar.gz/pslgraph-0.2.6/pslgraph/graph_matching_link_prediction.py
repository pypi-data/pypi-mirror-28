...
class GraphMatchingLinkPredictionHyperparams(d3m_metadata.hyperparams.Hyperparams):
    truth_threshold = d3m_metadata.hyperparams.Hyperparameter[float](
            default = 0.50,
            semantic_types = ['https://metadata.datadrivendiscovery.org/types/ControlParameter'])

    graph_matching_parser_hyperparams = d3m_metadata.hyperparams.Hyperparameter(
...
class GraphMatchingLinkPredictionParams(d3m_metadata.params.Params):
    training_set: Inputs
    debug_options: typing.Dict

class GraphMatchingLinkPrediction(primitive_interfaces.supervised_learning.SupervisedLearnerPrimitiveBase[Inputs, Outputs, GraphMatchingLinkPredictionParams, GraphMatchingLinkPredictionHyperparams]):
    """
    ...
    def __init__(self, *, hyperparams: GraphMatchingLinkPredictionHyperparams, random_seed: int = 0, _debug_options: typing.Dict = {}, docker_containers: typing.Dict[str, str] = None) -> None:
    ...
    def _get_true_links(self, graph: Graph) -> typing.Dict:
        ...
        for (source, target, data) in graph.edges(data = True):
            ...
            if (data[WEIGHT_KEY] >= self.hyperparams['truth_threshold']):
