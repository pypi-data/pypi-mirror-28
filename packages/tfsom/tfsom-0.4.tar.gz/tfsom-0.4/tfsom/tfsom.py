...
# POPULATE GRAPH WITH NECESSARY COMPONENTS
    ...
    def plot_u_matrix(self, title="U-Matrix", colors='Greys'):
        ...
        plot1.imshow(self.get_umat(), cmap=colors, interpolation='nearest')
        plt.title(title)
        plt.show()

    def plot_feat_grid(self, feat_num, title="Feature Grid", color="viridis"):
        fig1 = plt.figure(figsize=(8, 8))
        plot1 = fig1.add_subplot(1, 1, 1)
        plot1.imshow(self.get_feat_grid(feat_num), interpolation='nearest',
                     cmap=color)
        plt.title(title)
        plt.show()
    ...
    def plot_activity_matrix(self, input_vector,
        ...
        fig1 = plt.figure(figsize=(8, 8))
        plot1 = fig1.add_subplot(1, 1, 1)
        plot1.imshow(self.get_activity_mat(input_vector),
    ...
    def plot_qe(self, input_data, title="Quantization Error", color="Reds"):
        fig1 = plt.figure(figsize=(8, 8))
        plot1 = fig1.add_subplot(1, 1, 1)
        plot1.imshow(self.qe_mat(input_data), cmap=color,
                     interpolation='nearest')
        plt.title(title)
        plt.show()

    def plot_mqe(self, input_data, title="Mean Quantization Error",
                 color="Reds"):
        fig1 = plt.figure(figsize=(8, 8))
        plot1 = fig1.add_subplot(1, 1, 1)
        plot1.imshow(self.mqe_mat(input_data), cmap=color,
                     interpolation='nearest')
        plt.title(title)
        plt.show()
