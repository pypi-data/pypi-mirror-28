...
#else
    module = Py_InitModule3("bittrade._bittrade", module_functions, NULL);
#endif
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC init_bittrade(void) {
    moduleinit();
}
#else
PyMODINIT_FUNC PyInit__bittrade(void) {
    return moduleinit();
}
#endif
