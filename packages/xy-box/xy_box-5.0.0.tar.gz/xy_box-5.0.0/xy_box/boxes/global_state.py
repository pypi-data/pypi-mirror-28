...
PROPORTIONAL_FONT_FAMILY = ('Simhei','Arial',"MS", "Sans", "Serif")
MONOSPACE_FONT_FAMILY = "Arial"

# PROPORTIONAL_FONT_SIZE = 10
PROPORTIONAL_FONT_SIZE = 30
# a little smaller, because it is more legible at a smaller size
# MONOSPACE_FONT_SIZE = 9
MONOSPACE_FONT_SIZE = 50
# TEXT_ENTRY_FONT_SIZE = 12  # a little larger makes it easier to see
TEXT_ENTRY_FONT_SIZE = 30  # a little larger makes it easier to see
