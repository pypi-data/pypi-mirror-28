...
plugins = MENV.plugins.get_proxy()
"""
The intermake plugins, accessible as a Python object.
"""
...
def import_into( namespace ):
    """
    Puts all plugins into the root namespace.
    Not recommended. 
    """
    local = MENV.plugins.to_dictionary()
