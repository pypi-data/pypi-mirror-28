...
BROWSER_PATH = 'D:/Python/phantomjs-2.1.1-windows/bin/phantomjs'
USER_AGENT = [
...
class RequestBuilder(object):
    def __init__(self):
        ...
        self.headers = {
            'User-Agent': self.random_user_agent_header()
        }
...
def main():
    ...
    content = RequestBuilder().get_with_cookie(url).decode('utf-8')
    print(str(content))

    content = RequestBuilder().get_with_session(url).decode('utf-8')
    print(str(content))
