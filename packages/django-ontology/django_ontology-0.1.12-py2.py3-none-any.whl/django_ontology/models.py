...
class BaseConcept(ExpressionTypeMixin, TimeStampedModel, MPTTModel):
    ...
    def change_key(self, new_key):
        ...
        # for expression in self.expression_model.objects.filter(concept_id=self.key):
        #
        #     new_concept.set_expression(expression_type, self.get_expression(expression_type))
        #     print(expression_type, new_concept.get_expression(expression_type))
