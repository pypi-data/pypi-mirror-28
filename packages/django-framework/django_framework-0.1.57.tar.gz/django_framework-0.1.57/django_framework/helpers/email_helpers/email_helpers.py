...
# gmail_user = "info@chaienergy.net"
# gmail_pwd = "myChaiInfo89"
# from_gmail_user = "Chai Energy <info@chaienergy.net>"


def send_email(username, password, subject, message, recipient,  cc = None, bcc = None, reply_to = None, attach = None, html = None, pre = False, custom_headers = None):
    ec = EmailClient(recipient = recipient, subject = subject, message = message,
                     cc = cc, bcc = bcc, reply_to = reply_to, attach = attach, html = html, pre = pre, custom_headers = custom_headers)
...
class EmailClient(object):
    ...
    def __init__(self, recipient, subject, message, cc = None, bcc = None, reply_to = None, attach = None, html = None, pre = False, custom_headers = None):
...
# from_gmail_user = "Chai Energy <info@chaienergy.net>"
    ...
    recipient = 'ka+te.st@chaienergy.net'
    
    send_email(username = username, password = password, subject='te', message=message,  recipient = recipient, bcc = 'info@chaienergy.net')