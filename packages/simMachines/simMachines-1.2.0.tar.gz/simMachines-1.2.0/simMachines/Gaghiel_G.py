...
class Gaghiel_G():
    """
    Base class for a Gaghiel_G instance.
    ...
    def predict(self, X, *, version = ''):
        """
        Predict using a Gaghiel_G instance, returns recommendations and weights.
    ...
    def get_neighbors(self, X, *, version = ''):
        """
        Retrive nearest neighbors using trained Gaghiel_G instance.
