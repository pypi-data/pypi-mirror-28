...
from datasmash.utils import quantize_inplace, quantizer, smash, DatasetLoader, smashmatch
...
class SmashClassification(SupervisedLearnerPrimitiveBase[Inputs, Outputs,
                                                         Params, Hyperparams]):
    """
    ...
    metadata = metadata_module.PrimitiveMetadata({
        ...
        "name": "datasmash.classification.SmashClassification",
        "primitive_family": "CLASSIFICATION",
        "python_path": "d3m.primitives.datasmash.SmashClassification",
