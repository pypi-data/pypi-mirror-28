...
setup(name='datasmash',
      ...
      download_url='https://gitlab.datadrivendiscovery.org/uchicago/datasmash/archive/0.1.8.tar.gz',
      ...
      entry_points = {
          'd3m.primitives': [
              'datasmash.SmashClassification= datasmash.classification:SmashClassificiation',
          ],
      },
)
