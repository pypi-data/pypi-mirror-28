...
setup(name='datasmash',
      ...
      download_url='https://gitlab.datadrivendiscovery.org/uchicago/datasmash/archive/0.1.6.tar.gz',
      ...
      entry_points = {
          'd3m.primitives': [
              'datasmash.SmashClassification= datasmash.SmashClassification:SmashClassificiation',
          ],
      },
)
