...
from datasmash.utils import (quantizer, DatasetLoader, pprint_dict,
...
class SmashEmbedding(TransformerPrimitiveBase[Inputs, Outputs, Hyperparams]):
    """
    ...
    metadata = metadata_module.PrimitiveMetadata({
        ...
        "name": "datasmash.classification.SmashEmbedding",
        "primitive_family": "EVALUATION",
        "python_path": "d3m.primitives.datasmash.SmashEmbedding",
