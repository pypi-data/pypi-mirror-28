...
try:
    from ts3ekkoclient.ts3identity import replace_identity, startup
    from ts3ekkoclient.bot import EkkoBot
    from ts3ekkoclient.webhooks import EkkoRemoteControl
except ImportError:
    from .ts3identity import replace_identity, startup
    from .bot import EkkoBot
    from .webhooks import EkkoRemoteControl
...
def main():
    ...
    logger.info(f'ts3ekkoclient version: {ts3ekkoclient.__version__}')
