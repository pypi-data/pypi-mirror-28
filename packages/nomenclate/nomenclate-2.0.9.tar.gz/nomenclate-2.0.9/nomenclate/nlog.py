#!/bin/env python
# OpenSource 2013, Asi Soudai - www.asimation.com and Alex Segal
# All rights reserved.
#
...
directly using time-stamp and logging-level to keep the logs clean.
...
## -----------------------------------------------------------------------------
# let's test it... cause mistakes... happens... from time to time.
# __name__
## -----------------------------------------------------------------------------
