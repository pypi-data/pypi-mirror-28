...
class Source:
    def __init__(self, iterable, *, backend=Backend.THREAD, buffer_size=1):
...
class One2One(TransformerDescription):
    def __init__(self, f, *, backend=Backend.THREAD, n_workers=1, buffer_size=1):
...
class Many2One(TransformerDescription):
    def __init__(self, chunk_size, *, backend=Backend.THREAD, buffer_size=1):
