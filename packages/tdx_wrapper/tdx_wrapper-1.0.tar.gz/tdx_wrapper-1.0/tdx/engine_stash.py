...
class AsyncEngine(Engine):
    ...
    def get_k_data(self, code, start, end, freq):
        ...
        async def _get_k_data():
            loop = self.aapi.get_event_loop()
            res = [loop.run_in_executor(self.executor, self._get_transaction, code, trade_day) for trade_day in
                   trade_days]
        ...
        return self.aapi.run_until_complete(_get_k_data())
