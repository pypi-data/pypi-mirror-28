...
BASE_PATH = "/tmp/angel/fs"

HELP = """
This executable script is used to start/stop a angel_fs process as a daemon process.
...
def serve():
    from angel_fs import filesystem
    filesystem.serve_forever()
