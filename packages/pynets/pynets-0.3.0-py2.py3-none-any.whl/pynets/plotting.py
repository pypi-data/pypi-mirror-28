...
def plot_conn_mat(conn_matrix, conn_model, atlas_select, dir_path, ID, network, label_names, mask):
    ...
    if conn_model == 'corr':
        ...
        atlast_graph_title = str(atlas_select) + '_Tangent_Graph'
    elif conn_model == 'QuicGraphLasso':
        atlast_graph_title = str(atlas_select) + '_QuicGraphLasso_Graph'
    elif conn_model == 'QuicGraphLassoCV':
        atlast_graph_title = str(atlas_select) + '_QuicGraphLassoCV_Graph'
    elif conn_model == 'QuicGraphLassoEBIC':
        atlast_graph_title = str(atlas_select) + '_QuicGraphLassoEBIC_Graph'
    elif conn_model == 'AdaptiveQuicGraphLasso':
        atlast_graph_title = str(atlas_select) + '_AdaptiveQuicGraphLasso_Graph'
    if mask != None:
