...
static sipEnumMemberDef enummembers_wxNavigationKeyEvent[] = {
    {sipName_FromTab, static_cast<int>( ::wxNavigationKeyEvent::FromTab), 344},
    {sipName_IsBackward, static_cast<int>( ::wxNavigationKeyEvent::IsBackward), 344},
    {sipName_IsForward, static_cast<int>( ::wxNavigationKeyEvent::IsForward), 344},
    {sipName_WinChange, static_cast<int>( ::wxNavigationKeyEvent::WinChange), 344},
};
