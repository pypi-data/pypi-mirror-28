...
void sipwxHtmlWinTagHandler::SetParser( ::wxHtmlWinParser*parser)
{
    ...
    extern void sipVH__html_58(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxHtmlWinParser*);

    sipVH__html_58(sipGILState, 0, sipPySelf, sipMeth, parser);
}
