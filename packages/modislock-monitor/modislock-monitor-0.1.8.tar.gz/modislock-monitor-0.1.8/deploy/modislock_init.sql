...
add_reading:BEGIN
    ...
    SELECT SLEEP(10);
    DELETE A.* 
    FROM readings A LEFT JOIN readings_window B USING (id);
...
START TRANSACTION;
USE `modislock`;
INSERT INTO `modislock`.`reader_settings` (`id_reader`, `location_name`, `location_direction`, `settings_id_settings`) VALUES (0, 'HOST', 'NONE', 0);
INSERT INTO `modislock`.`reader_settings` (`id_reader`, `location_name`, `location_direction`, `settings_id_settings`) VALUES (1, 'READER 1', 'ENTRY', 9);
INSERT INTO `modislock`.`reader_settings` (`id_reader`, `location_name`, `location_direction`, `settings_id_settings`) VALUES (2, 'READER 2', 'EXIT', 10);
INSERT INTO `modislock`.`reader_settings` (`id_reader`, `location_name`, `location_direction`, `settings_id_settings`) VALUES (3, 'READER 3', 'ENTRY', 9);
INSERT INTO `modislock`.`reader_settings` (`id_reader`, `location_name`, `location_direction`, `settings_id_settings`) VALUES (4, 'READER 4', 'EXIT', 10);
...
START TRANSACTION;
USE `modislock`;
INSERT INTO `modislock`.`locations` (`id_locations`, `name`, `reader_settings_id_reader`) VALUES (0, 'HOST_CONTROLLER', NULL);
INSERT INTO `modislock`.`locations` (`id_locations`, `name`, `reader_settings_id_reader`) VALUES (1, 'READER1', 1);
INSERT INTO `modislock`.`locations` (`id_locations`, `name`, `reader_settings_id_reader`) VALUES (2, 'READER2', 2);
INSERT INTO `modislock`.`locations` (`id_locations`, `name`, `reader_settings_id_reader`) VALUES (3, 'READER3', 3);
INSERT INTO `modislock`.`locations` (`id_locations`, `name`, `reader_settings_id_reader`) VALUES (4, 'READER4', 4);
INSERT INTO `modislock`.`locations` (`id_locations`, `name`, `reader_settings_id_reader`) VALUES (99, 'HOST', NULL);
...
START TRANSACTION;
USE `modislock`;
INSERT INTO `modislock`.`sensors` (`id_sensors`, `name`, `units`, `locations_id_locations`) VALUES (DEFAULT, 'TEMP_HOST_CPU', 'float', 99);
INSERT INTO `modislock`.`sensors` (`id_sensors`, `name`, `units`, `locations_id_locations`) VALUES (DEFAULT, 'TEMP_HOST_CONTROLLER_CPU', 'float', 0);
INSERT INTO `modislock`.`sensors` (`id_sensors`, `name`, `units`, `locations_id_locations`) VALUES (DEFAULT, 'TEMP_READER1', 'float', 1);
INSERT INTO `modislock`.`sensors` (`id_sensors`, `name`, `units`, `locations_id_locations`) VALUES (DEFAULT, 'TEMP_READER2', 'float', 2);
INSERT INTO `modislock`.`sensors` (`id_sensors`, `name`, `units`, `locations_id_locations`) VALUES (DEFAULT, 'TEMP_READER3', 'float', 3);
INSERT INTO `modislock`.`sensors` (`id_sensors`, `name`, `units`, `locations_id_locations`) VALUES (DEFAULT, 'TEMP_READER4', 'float', 4);
INSERT INTO `modislock`.`sensors` (`id_sensors`, `name`, `units`, `locations_id_locations`) VALUES (DEFAULT, 'VALIDATION_COUNT_READER1', 'integer', 1);
INSERT INTO `modislock`.`sensors` (`id_sensors`, `name`, `units`, `locations_id_locations`) VALUES (DEFAULT, 'VALIDATION_COUNT_READER2', 'integer', 2);
INSERT INTO `modislock`.`sensors` (`id_sensors`, `name`, `units`, `locations_id_locations`) VALUES (DEFAULT, 'VALIDATION_COUNT_READER3', 'integer', 3);
INSERT INTO `modislock`.`sensors` (`id_sensors`, `name`, `units`, `locations_id_locations`) VALUES (DEFAULT, 'VALIDATION_COUNT_READER4', 'integer', 4);
INSERT INTO `modislock`.`sensors` (`id_sensors`, `name`, `units`, `locations_id_locations`) VALUES (DEFAULT, 'DENIED_COUNT_READER1', 'integer', 1);
INSERT INTO `modislock`.`sensors` (`id_sensors`, `name`, `units`, `locations_id_locations`) VALUES (DEFAULT, 'DENIED_COUNT_READER2', 'integer', 2);
INSERT INTO `modislock`.`sensors` (`id_sensors`, `name`, `units`, `locations_id_locations`) VALUES (DEFAULT, 'DENIED_COUNT_READER3', 'integer', 3);
INSERT INTO `modislock`.`sensors` (`id_sensors`, `name`, `units`, `locations_id_locations`) VALUES (DEFAULT, 'DENIED_COUNT_READER4', 'integer', 4);
INSERT INTO `modislock`.`sensors` (`id_sensors`, `name`, `units`, `locations_id_locations`) VALUES (DEFAULT, 'VALIDATION_COUNT_HOST', 'integer', 0);
INSERT INTO `modislock`.`sensors` (`id_sensors`, `name`, `units`, `locations_id_locations`) VALUES (DEFAULT, 'DENIED_COUNT_HOST', 'integer', 0);
INSERT INTO `modislock`.`sensors` (`id_sensors`, `name`, `units`, `locations_id_locations`) VALUES (DEFAULT, 'TEMP_HOST_CASE', 'integer', 99);
