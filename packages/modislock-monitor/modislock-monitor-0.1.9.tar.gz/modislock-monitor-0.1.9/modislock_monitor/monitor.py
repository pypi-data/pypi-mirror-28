...
class Monitor(Thread):
    ...
    def _door_callback(self, door_id, value):
        ...
        :return:
        """
        self.monitor.events.enqueue(Monitor.handle_doors, args=[door_id, value], priority=100)
    ...
    def _reader_callback(self, reader_id, value):
        ...
        :return:
        """
        self.monitor.events.enqueue(Monitor.handle_reader, args=[reader_id, value], priority=100)
    ...
    def handle_incoming(cls, packet):
        ...
        try:
            ...
            if frame_type == SlaveResponse.RESPONSE_NO_EVENT:
                ...
                cls.monitor.events.enqueue(Monitor.handle_status, args=[packet], priority=150)
    ...
    def _request_status(self):
        ...
        self.monitor.events.enqueue(Monitor.handle_outgoing,
                                    args=[SlaveRequest(0, SlaveRequest.REQUEST_STATUS, ControllerMessage.CONTROLLER_STATUS)],
                                    priority=150)
    ...
    def run(self):
        ...
        self.monitor.events.enqueue(Monitor.handle_outgoing,
                                    args=[SlaveRequest(0, SlaveRequest.REQUEST_STATUS, ControllerMessage.CONTROLLER_REBOOT)],
                                    priority=160)
