...
class SlaveResponse(SlaveMessageBase):
    ...
    def __init__(self, raw_msg):
        ...
        """
        super(SlaveResponse, self).__init__()
        ...
        if isinstance(raw_msg, (bytes, bytearray)):
            ...
            self._status = {'temp': '0.00', 'validations': 0, 'denials': 0}

            if self._frame_type == self.RESPONSE_STATUS and self._data_size is not 0:
...
class SlaveRequest(SlaveMessageBase):
    ...
    def __init__(self, address, request_type, data=None):
        super(SlaveRequest, self).__init__()
...
class ControllerMessage(SlaveMessageBase):
    ...
    def __init__(self, command, address=0x00):
        ...
        self._message = bytearray()
        self._message.append(address)
        self._message.append(int.from_bytes(self.CONTROLLER_STATUS, byteorder='big'))
