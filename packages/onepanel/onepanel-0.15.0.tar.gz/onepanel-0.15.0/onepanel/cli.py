...
from onepanel.commands.instances import notebooks
from onepanel.commands.volume_types import volume_types
from onepanel.commands.common import clone, push, pull
...
@click.group()
@click.version_option(version='0.15.0', prog_name='Onepanel CLI')
@click.pass_context
def cli(ctx):
    conn = Connection()
