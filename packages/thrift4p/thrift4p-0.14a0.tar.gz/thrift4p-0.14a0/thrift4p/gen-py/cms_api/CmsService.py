...
class Iface:
  ...
  def insertDetail(self, batchId, userId, balance, allOrderNum, actualOrderNum):
    """
    Parameters:
     - batchId
     - userId
  ...
  def taxiOrderHoldAndDebit(self, taxi_order_id, holdContent, isSend, sys_op_id, debitType, debitMoney):
    """
    Parameters:
     - taxi_order_id
     - holdContent
...
class Client(Iface):
  ...
  def insertDetail(self, batchId, userId, balance, allOrderNum, actualOrderNum):
    ...
    Parameters:
     ...
     - actualOrderNum
    """
    self.send_insertDetail(batchId, userId, balance, allOrderNum, actualOrderNum)
    return self.recv_insertDetail()

  def send_insertDetail(self, batchId, userId, balance, allOrderNum, actualOrderNum):
  ...
  def taxiOrderHoldAndDebit(self, taxi_order_id, holdContent, isSend, sys_op_id, debitType, debitMoney):
    ...
    Parameters:
     ...
     - debitMoney
    """
    self.send_taxiOrderHoldAndDebit(taxi_order_id, holdContent, isSend, sys_op_id, debitType, debitMoney)
    return self.recv_taxiOrderHoldAndDebit()

  def send_taxiOrderHoldAndDebit(self, taxi_order_id, holdContent, isSend, sys_op_id, debitType, debitMoney):
    self._oprot.writeMessageBegin('taxiOrderHoldAndDebit', TMessageType.CALL, self._seqid)
    args = taxiOrderHoldAndDebit_args()
    args.taxi_order_id = taxi_order_id
    args.holdContent = holdContent
    args.isSend = isSend
    args.sys_op_id = sys_op_id
  ...
  def recv_taxiOrderHoldAndDebit(self):
    iprot = self._iprot
    (fname, mtype, rseqid) = iprot.readMessageBegin()
    if mtype == TMessageType.EXCEPTION:
      x = TApplicationException()
      ...
      iprot.readMessageEnd()
      raise x
    result = taxiOrderHoldAndDebit_result()
    result.read(iprot)
    iprot.readMessageEnd()
    if result.success is not None:
      return result.success
    raise TApplicationException(TApplicationException.MISSING_RESULT, "taxiOrderHoldAndDebit failed: unknown result")
...
class Processor(Iface, TProcessor):
  def __init__(self, handler):
    ...
    self._processMap["taxiOrderHoldAndDebit"] = Processor.process_taxiOrderHoldAndDebit
  ...
  def process_insertDetail(self, seqid, iprot, oprot):
    ...
    result = insertDetail_result()
    try:
      result.success = self._handler.insertDetail(args.batchId, args.userId, args.balance, args.allOrderNum, args.actualOrderNum)
      msg_type = TMessageType.REPLY
    except (TTransport.TTransportException, KeyboardInterrupt, SystemExit):
      raise
    except Exception as ex:
  ...
  def process_taxiOrderHoldAndDebit(self, seqid, iprot, oprot):
    args = taxiOrderHoldAndDebit_args()
    args.read(iprot)
    iprot.readMessageEnd()
    result = taxiOrderHoldAndDebit_result()
    try:
      result.success = self._handler.taxiOrderHoldAndDebit(args.taxi_order_id, args.holdContent, args.isSend, args.sys_op_id, args.debitType, args.debitMoney)
      msg_type = TMessageType.REPLY
    except (TTransport.TTransportException, KeyboardInterrupt, SystemExit):
      raise
    except Exception as ex:
      ...
      logging.exception(ex)
      result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
    oprot.writeMessageBegin("taxiOrderHoldAndDebit", msg_type, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
...
class insertDetail_args:
  ...
  def __init__(self, batchId=None, userId=None, balance=None, allOrderNum=None, actualOrderNum=None,):
...
class taxiOrderHoldAndDebit_args:
  """
  Attributes:
   - taxi_order_id
   - holdContent
  ...
  thrift_spec = (
    ...
    (3, TType.BOOL, 'isSend', None, None, ), # 3
    (4, TType.I64, 'sys_op_id', None, None, ), # 4
    (5, TType.I32, 'debitType', None, None, ), # 5
    (6, TType.STRING, 'debitMoney', None, None, ), # 6
  )

  def __init__(self, taxi_order_id=None, holdContent=None, isSend=None, sys_op_id=None, debitType=None, debitMoney=None,):
    self.taxi_order_id = taxi_order_id
    self.holdContent = holdContent
    self.isSend = isSend
    self.sys_op_id = sys_op_id
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('taxiOrderHoldAndDebit_args')
    if self.taxi_order_id is not None:
      oprot.writeFieldBegin('taxi_order_id', TType.I64, 1)
      oprot.writeI64(self.taxi_order_id)
      oprot.writeFieldEnd()
    ...
    if self.debitType is not None:
      oprot.writeFieldBegin('debitType', TType.I32, 5)
      oprot.writeI32(self.debitType)
      oprot.writeFieldEnd()
    if self.debitMoney is not None:
      oprot.writeFieldBegin('debitMoney', TType.STRING, 6)
...
class taxiOrderHoldAndDebit_result:
  """
  Attributes:
   - success
  """
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('taxiOrderHoldAndDebit_result')
    if self.success is not None:
      oprot.writeFieldBegin('success', TType.STRUCT, 0)
      self.success.write(oprot)
      oprot.writeFieldEnd()
