...
#    totalNumOfFeatures = numOfTimeSpectralFeatures + nceps + numOfHarmonicFeatures
    ...
    while (
            curPos +
            Win -
            1 < N):                        # for each short-term window until the end of signal
        countFrames += 1
        ...
        curFV[numOfTimeSpectralFeatures +
              nceps: numOfTimeSpectralFeatures +
              nceps +
              numOfChromaFeatures -
              1] = chromaF
...
# print curFV[numOfTimeSpectralFeatures+nceps],
# curFV[numOfTimeSpectralFeatures+nceps+1]
...
def mtFeatureExtractionToFileDir(
        dirName,
        midTermSize,
        midTermStep,
        shortTermSize,
