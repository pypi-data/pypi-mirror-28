...
def tv_identify(zp_filefolder_id):
    ...
    if identified != True and exists == True:
        ...
        tv_path = current_app.config["AdminHTTPTVFuncs"].film_path(zp_filefolder_id)
...
def tv_summary(zp_tv_id):
    ...
    tv_path = current_app.config["AdminHTTPTVFuncs"].tv_path(current_app.config[
                                                "AdminHTTPTVFuncs"].get_tv_filefolder_id(zp_tv_id))
