...
# -*- coding: utf-8 -*-
#
# email-audit documentation build configuration file, created by
...
htmlhelp_basename = 'email_auditdoc'
...
# [howto/manual]).
latex_documents = [
    ('index', 'email_audit.tex',
     u'email audit Documentation',
