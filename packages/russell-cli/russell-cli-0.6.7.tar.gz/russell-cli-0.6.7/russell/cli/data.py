...
import shutil
import russell
from russell.cli.utils import get_file_count
...
@click.pass_context
def upload(ctx, r, message, nopack):
    """
    ...
    upload_filename = './'
    if get_file_count(upload_filename) > 100:
    ...
    _TEMP_DIR = os.path.expanduser("~/.russellDataTemp")

    fc = FsClient()
    try:
        fc.socket_upload(file_type="data",
                         filename=_TEMP_UPLOAD_DIR,
