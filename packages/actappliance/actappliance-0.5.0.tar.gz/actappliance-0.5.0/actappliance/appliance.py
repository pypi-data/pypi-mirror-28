...
class Appliance:
    ...
    def __init__(self, hostname=None, ip_address=None, connection_type='rest', appliance_type=None, version=None,
        ...
        """
        self._connection_type = self.appliance_type = self._version = None
    ...
    def connection_type(self, value):
        ...
        if connection_type in self.conn_types:
            self._connection_type = self.conn_types[connection_type]
        else:
            raise ValueError("'connection_type' must be {}".format(self.conn_types_str))
    ...
    def appliance_type(self, value):
        self._appliance_type = value if value is not None and value.lower() in appl_types else None
