...
try:  # line 8
    ...
    Number = Union[int, float]  # line 10
...
class MergeBlock(_coconut_NamedTuple("MergeBlock", [("tipe", 'MergeBlockType'), ("lines", '_coconut.typing.Sequence[str]'), ("line", 'int'), ("replaces", '_coconut.typing.Optional[MergeBlock]'), ("changes", '_coconut.typing.Optional[Range]')])):  # line 69
    __slots__ = ()  # line 69
...
try:  # line 115
    ...
    pass  # line 116
def safeSplit(s: 'Splittable', d: '_coconut.typing.Optional[Splittable]'=None) -> '_coconut.typing.Sequence[Splittable]':  # line 117
    return s.split((("\n" if isinstance(s, str) else b"\n") if d is None else d)) if len(s) > 0 else []  # line 117

def ajoin(sep: 'str', seq: '_coconut.typing.Sequence[str]', nl="") -> 'str':  # line 119
...
def Exit(message: 'str'="", code=1) -> 'None':  # line 136
...
def detectAndLoad(filename: '_coconut.typing.Optional[str]'=None, content: '_coconut.typing.Optional[bytes]'=None) -> 'Tuple[str, bytes, _coconut.typing.Sequence[str]]':  # line 163
    ...
    if filename is not None:  # line 169
        with codecs.open(filename, encoding=encoding) as fd:  # line 170
...
def user_block_input(output: 'List[str]') -> 'None':  # line 200
