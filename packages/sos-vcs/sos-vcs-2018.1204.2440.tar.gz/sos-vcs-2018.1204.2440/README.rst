...
-  Version 1.2 released on 2018-02-04:
   ...
   -  `Enhancement
      124 <https://github.com/ArneBachmann/sos/issues/124>`__ Use enum
   -  `Enhancement
      137 <https://github.com/ArneBachmann/sos/issues/137>`__ Better
      usage pages
   -  `Enhancement 142,
      143 <https://github.com/ArneBachmann/sos/issues/142>`__ Improved
      ``sos config`` and added local configurations
   -  `Enhancement
      153 <https://github.com/ArneBachmann/sos/issues/153>`__ Removed
      Python 2 leftovers
   -  `Enhancement
      159 <https://github.com/ArneBachmann/sos/issues/159>`__ Metadata
      updates
   -  `Feature 134,
