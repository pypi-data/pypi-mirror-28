...
class StorageTest(InvoiceTest):
    ...
    def test_import(self):
        ...
        self.assert_grid_equal('article', {"reference": "référence", "designation": "désignation", "price_txt": "prix", "unit": "unité", "isdisabled": "désactivé ?", "sell_account": "compte de vente", "stockable": "stockable", "stockage_total": "quantités"}, 4)
