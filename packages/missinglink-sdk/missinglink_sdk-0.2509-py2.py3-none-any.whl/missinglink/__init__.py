...
def do_import():
    ...
    from missinglink_kernel import \
        ...
        ExperimentStopped, MissingLinkException, set_global_root_logger_sniffer, MLImageDataGenerator
    ...
    return KerasCallback, TensorFlowCallback, TensorFlowProject, PyTorchCallback, PyCaffeCallback, \
           ExperimentStopped, MissingLinkException, MLImageDataGenerator
...
PyCaffeCallback, ExperimentStopped, MissingLinkException, MLImageDataGenerator = do_import()
