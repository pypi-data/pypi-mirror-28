...
class BaseSEOMeta(ComparableFrame, metaclass=_BaseSEOMetaMeta):
    ...
    # The project used when returning an SEO meta instance via the `seo_meta`
    # property against the related parent document.
    ...
    def url(self):
        """
        Return the URL for the SEO meta instance. Note: this is only applicable
        to SEO meta instances that decorate a flask view.
        """
    ...
    def decorated(cls):
        ...
        """
        return list(cls._decorated.values())
