...
def optimize(model_version: ModelVersion, transform_graph_path, output_path=None):
    ...
    for meta_graph_def in saved_model_def.meta_graphs:
        ...
        froze_graph = freeze_model(meta_graph_def, output_node_names, model_version.local_path)
        transformed_graph = transform_graph(froze_graph, transform_graph_path, input_nodes_name_type_shape, output_node_names)
...
def freeze_model(meta_graph_def, output_node_names, input_saved_model_dir):
...
def transform_graph(graph, transform_graph_path, input_nodes_name_type_shape, output_node_names):
