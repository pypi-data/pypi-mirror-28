...
def part_bom_compare_other(request, pk, other_pk):
    ...
    bom_qty = {}
    for item in bom_part.assembly_items():
        bom_qty[item.comp.best_part()] = item.qty
    other_bom_qty = {}
    for item in other_bom_part.assembly_items():
        other_bom_qty[item.comp.best_part()] = item.qty
