...
def navsy_is(context, target, value):
    ...
    if isinstance(target, Page):
        ...
        route_obj = data.get('navsy_route', None)
        return value if route_obj and route_obj.view_name == target else ''
    else:
        return ''
...
@assignment_tag(takes_context=True)
def navsy_is_child(context, target, value):
    ...
    if isinstance(target, Page):
        page_target_data = { 'object':target }
    ...
    return value if page_obj and page_target_obj and page_obj.pk in page_target_obj.get_parents_pks() else ''


@assignment_tag(takes_context=True)
def navsy_is_parent(context, target, value):
    ...
    page_target_obj = page_target_data.get('object')
    return value if page_obj and page_target_obj and page_target_obj.pk in page_obj.get_parents_pks() else ''
