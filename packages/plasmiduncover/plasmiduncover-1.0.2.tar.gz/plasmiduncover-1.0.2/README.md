...
### If you installed using pipy

`PlasmidUNCover -idx <path/to/indexes_folder> -r <path/to/reads_folder> -t 1 -o test -c 0.6`

### If you installed using git clone
`./plasmiduncover/PlasmidUNCover.py -idx <path/to/indexes_folder> -r 
