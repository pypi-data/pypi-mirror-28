...
class API:
    ...
    def get_products_public(self, group_id, page=None, format=None):
        """Get products from a public group"""
        args = {
                "group_id": group_id,
                "page": page,
                "format": format}
    ...
    def get_subscriptions_public(self, group_id, format=None):
        """Get subscriptions from a public group"""
        args = {
                "group_id": group_id,
                "format": format}
