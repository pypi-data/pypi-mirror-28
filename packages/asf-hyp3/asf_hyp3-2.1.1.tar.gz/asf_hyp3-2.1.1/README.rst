...
:Parameters:
    ...
    Optional - id, sub_id, creation_date, start_date, end_date, name, group_id, page, format

:Returns:
    A list of dictionaries containing product information for products with
    the specified attributes. The list is limited to 1013 items, but more items
    can be retrieved with the page parameter (first page is 0).
...
:Parameters:
    ...
    Optional - name, description, add_subs, rem_subs, add_users, rem_users
