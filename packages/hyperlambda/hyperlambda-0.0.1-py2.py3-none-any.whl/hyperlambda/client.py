...
class lamda(object):
    ...
    def invoke_function(self,function_name=None,runtime='python2.7',role=None,timeout=180,handler=None,code=None,zip_file=None
                            ,data=None,environment=None,tags=None,instance_type=settings.instance_type,key_name=settings.key_name,security_group_ids=settings.security_group_ids,callback_url=None):
        ...
        elif environment !=None and not isinstance(environment,(dict)):
            if 'Variable' in environment and isinstance(environment['Variable'],(dict)):
                pass
            else:
    ...
    def execute_function(self):
        try:
            ...
            if created:
                time.sleep(35)  ## waiting for the instance server to be ready to receive requests.
