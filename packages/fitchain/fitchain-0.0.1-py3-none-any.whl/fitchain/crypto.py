"""
    ...
    :copyright: (c) 2015,2016,2017 Francesco Gadaleta
    :author: Francesco Gadaleta (francesco.gadaleta@gmail.com)
    :license: Amethix Technologies (LICENSE.txt)
"""
...
class SymmetricBox(object):
    ...
    def decrypt(self, message):python
