...
class QueryDataGenerator(Iterator):
    def __init__(self, multi_process_control, cache_directory, data_callback, volume_id, query, batch_size=32):
        ...
        super(QueryDataGenerator, self).__init__(total_items, batch_size)
