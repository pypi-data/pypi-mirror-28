...
class InceptionFlow():
    ...
    def prepare_file_system(self):
        ...
        if INTERMEDIATE_STORE_FREQ > 0:
            ...
            ensure_dir_exists(FLAGS.FACIAL_MODEL_DIR)
    ...
    def create_model_info(self,architecture):
        ...
        but found '%s' for architecture '%s'""",size_string, architecture)
            ...
            if is_quantized:
                ...
                OBJECT_MODEL = 'http://download.tensorflow.org/models/mobilenet_v1_'
                OBJECT_MODEL += version_string + '_' + size_string + '_quantized_frozen.tgz'
                ...
                OBJECT_MODEL = 'http://download.tensorflow.org/models/mobilenet_v1_'
                OBJECT_MODEL += version_string + '_' + size_string + '_frozen.tgz'
                bottleneck_tensor_name = 'MobilenetV1/Predictions/Reshape:0'
    ...
    def trainModel(self):
        ...
        self.checkModelDownload(model_info['OBJECT_MODEL'])

        graph, bottleneck_tensor, resized_image_tensor = (
                self.create_model_graph(model_info))
                
        # Look at the folder structure, and create lists of all the images.
        image_lists = create_image_lists(FACIAL_IMAGES_DIR, TESTING_PERCENTAGE,
        ...
        with tf.Session(graph=graph) as sess:
            ...
            save_graph_to_file(sess, graph, FACIAL_MODEL_PATH)
