...
class BaseMixin(object):
    ...
    def _setup_db(self, spider_id=None, config=None):
        ...
        if not isinstance(config, dict):
            raise NameError(u"ERROR db:{}".format(config))
