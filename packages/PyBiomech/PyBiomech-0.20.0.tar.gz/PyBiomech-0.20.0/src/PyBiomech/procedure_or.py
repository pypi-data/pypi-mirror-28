            ...
            if 'Blankevoort_1991' in ligaModels:
                ...
                if ligaName == 'MCL':
                    ...
                    if tibiaPlateauMedEdgeParamsSplineLoc is None:
                        ...
                        raise Exception('"Blankevoort_1991" methods requires input "tibiaPlateauMedEdgeSplineLoc" for MCL')
                    ...
                    if tibiaPlateauLatEdgeParamsSplineLoc is None:
                        ...
                        raise Exception('"Blankevoort_1991" methods requires input "tibiaPlateauLatEdgeSplineLoc" for LCL')
