...
class ImgClassifierWebAPI(web_api.WebAPIBase):
  ...
  def form_pred_res(self, clf_pred_res):
    """Form api response with prediction results.
    """
    assert isinstance(clf_pred_res, common.ImgClfPred)
    res = {
        "label_names": clf_pred_res.label_names,
        "label_scores": clf_pred_res.label_scores
    }
    return res
  ...
  def predict(self):
    ...
    try:
      ...
      if request.method == "POST":
        ...
        res_obj = web_api.make_success_res_obj(clf_pred)
