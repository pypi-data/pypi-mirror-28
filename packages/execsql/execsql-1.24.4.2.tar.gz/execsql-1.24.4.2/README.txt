...
--------- | ---------- | ----------------------------------------------
1.24.3.0  | 2017-12-31 | Allowed "CREATE SCRIPT" as an alias for "BEGIN SCRIPT".  Allowed "DEBUG WRITE SCRIPT" as an alias for "WRITE SCRIPT".  Added the "-o" command-line option to display online help.
