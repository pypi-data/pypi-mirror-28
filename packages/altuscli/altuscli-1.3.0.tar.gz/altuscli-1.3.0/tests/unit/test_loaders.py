...
from altuscli.loader import JSONFileLoader
from altuscli.loader import Loader
from altuscli.loader import YAMLFileLoader
...
class TestLoader(unittest.TestCase):
    ...
    def test_list_available_services(self, *args):
        ...
        self.assertEqual(0, len(set(services).symmetric_difference(['service-1',
                                                                    'service-2',
                                                                    'service-3',
                                                                    'service-4',
                                                                    'service-5'])))
