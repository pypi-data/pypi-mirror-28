...
class TestArgumentGenerator(unittest.TestCase):
    ...
    def assert_skeleton_from_model_is(self,
                                      model,
                                      generated_skeleton,
                                      include_hidden):
        shape = DenormalizedStructureBuilder().with_members(
            model).build_model()
        actual = self.arg_generator.generate_skeleton(shape, include_hidden)
    ...
    def test_generate_scalars(self):
        ...
        self.assert_skeleton_from_model_is(
            model={
                'A': {'type': 'string', 'x-hidden': True},
                'B': {'type': 'integer', 'x-hidden': True},
                'C': {'type': 'number', 'x-hidden': True},
                'D': {'type': 'boolean', 'x-hidden': True}
            },
            generated_skeleton={
            },
            include_hidden=False
