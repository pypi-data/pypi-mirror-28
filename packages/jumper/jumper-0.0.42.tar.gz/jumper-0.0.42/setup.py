...
setup(
    ...
    install_requires=['future', 'pyserial', 'timeout-decorator', 'requests', 'termcolor', 'terminaltables'],
    ...
    # },
    package_data={'jumper': ['LICENSE.txt', 'NOTICE.txt', 'hci/hci', 'hci/peripherals.json', 'hci/scenario.json', 'default_bsp.json']},
