...
API_URL = 'https://us-central1-jemu-web-app.cloudfunctions.net/api/v1' if 'JUMPER_STAGING' not in os.environ else \
    'https://us-central1-jemu-web-app-staging.cloudfunctions.net/api/v1'
...
class JemuWebApi(object):
    ...
    def get_archived_emulator(self, fw_filename, fw_bin_data, dest):
        signs = {"$", "#", "[", "]"}
        ...
        self.send_event('firmware download success')
