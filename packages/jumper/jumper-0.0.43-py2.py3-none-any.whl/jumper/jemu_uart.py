...
class JemuUart(object):
    ...
    def wait_until_uart_receives(self, data, timeout=None):
        ...
        :param timeout: Emulation time specified in milliseconds. TimeoutException is raised if timeout occurred before data was available in the buffer.
        ...
        self._buffer += self._uart_device.read()
        ...
        raise TimeoutException("timeout while waiting for data")
