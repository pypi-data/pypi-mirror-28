...
class okerrclient_api():
    ...
    def make_parser(self, parser):
        ...
        parser_apir.add_argument('--api-getarg', metavar=('indicator','argument'), default=None, nargs=2, help='get one argument of indicator')
        ...
        parser_apiw.add_argument('--api-setarg', nargs='+', help='set indicator arguments (name=value)')
        parser_apiw.add_argument('--api-set', nargs='+', help='set indicator options (name=value)')
    ...
    def partner_grant(self, partner_id, group):
    ...
    def run_api_commands(self, args):
        ...
        if args.api_getarg:
            self.getarg(args.api_getarg[0], args.api_getarg[1])
            worked = True
