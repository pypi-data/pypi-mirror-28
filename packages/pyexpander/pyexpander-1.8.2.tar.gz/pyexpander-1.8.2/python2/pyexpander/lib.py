...
def processToPrint(parse_list, filename=None,
                   ...
                   auto_indent= False,
                   include_paths=None):
    """gets a parse list and prints the expanded text.

    returns:
        exp_globals : the internal globals() dictionary.
    """
    # pylint: disable=too-many-arguments
    # debug:
...
def expandStr(st, filename=None,
              external_definitions=None,
              allow_nobracket_vars= False,
              auto_continuation= False,
              auto_indent= False,
              include_paths=None):
    """gets a string and returns the expanded text as a string.

    Returns a tuple consisting of:
        expanded_text : the expanded text as a single string.
        global_dict   : the global dict
    """
    # pylint: disable=too-many-arguments
    return processToList(parseString(st), filename,
                         external_definitions,
                         allow_nobracket_vars,
                         auto_continuation,
                         auto_indent,
...
def expand(st, filename=None,
           ...
           auto_indent= False,
           include_paths=None):
    """gets a string and prints the expanded text.
...
def expandFile(filename,
    ...
    """gets a filename and prints the expanded text.
