...
from preprocesselement import PreprocessElement
...
class PreprocessICM:
    ...
    def __init__(self, regexes=None, input_file=None):
        self.regexes = []
                ...
                for reg in self.regexes:
                    while True:
                        ...
                        if sub_param_match is not None:
                            ...
                            for cur_param in sub_param_match.group(2).split(","):
                                ...
                                try:
                                    ...
                                    print "Couldn't replace 1 through 9"
                        ...
                        if len(my_params) > 0 and do_sub:
                            ...
                            elements.append(
                                PreprocessElement(num=cur_param_num, title=element_title, params=my_params))
