...
class Iface(object):
    ...
    def createUser(self, apiKey, username, email, password):
        """
        Parameters:
         - apiKey
         - username
    ...
    def authenticateUser(self, apiKey, username, password):
        """
        Parameters:
         - apiKey
         - username
    ...
    def getMyProjectOverviews(self, apiKey):
        """
        Parameters:
         - apiKey
        """
...
class Client(Iface):
    ...
    def createUser(self, apiKey, username, email, password):
        ...
        Parameters:
         ...
         - password
        """
        self.send_createUser(apiKey, username, email, password)
        return self.recv_createUser()

    def send_createUser(self, apiKey, username, email, password):
    ...
    def authenticateUser(self, apiKey, username, password):
        ...
        Parameters:
         ...
         - password
        """
        self.send_authenticateUser(apiKey, username, password)
        return self.recv_authenticateUser()

    def send_authenticateUser(self, apiKey, username, password):
    ...
    def getMyProjectOverviews(self, apiKey):
        ...
        Parameters:
         - apiKey
        """
        self.send_getMyProjectOverviews(apiKey)
        return self.recv_getMyProjectOverviews()

    def send_getMyProjectOverviews(self, apiKey):
        self._oprot.writeMessageBegin('getMyProjectOverviews', TMessageType.CALL, self._seqid)
        args = getMyProjectOverviews_args()
        args.apiKey = apiKey
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_getMyProjectOverviews(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = getMyProjectOverviews_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        if result.svEx is not None:
            raise result.svEx
        raise TApplicationException(TApplicationException.MISSING_RESULT, "getMyProjectOverviews failed: unknown result")
...
class Processor(Iface, TProcessor):
    def __init__(self, handler):
        ...
        self._processMap["getMyProjectOverviews"] = Processor.process_getMyProjectOverviews
    ...
    def process_createUser(self, seqid, iprot, oprot):
        ...
        result = createUser_result()
        try:
            result.success = self._handler.createUser(args.apiKey, args.username, args.email, args.password)
            msg_type = TMessageType.REPLY
        except (TTransport.TTransportException, KeyboardInterrupt, SystemExit):
            raise
        except Exception as ex:
    ...
    def process_authenticateUser(self, seqid, iprot, oprot):
        ...
        result = authenticateUser_result()
        try:
            result.success = self._handler.authenticateUser(args.apiKey, args.username, args.password)
            msg_type = TMessageType.REPLY
        except (TTransport.TTransportException, KeyboardInterrupt, SystemExit):
            raise
        except Exception as ex:
    ...
    def process_getMyProjectOverviews(self, seqid, iprot, oprot):
        args = getMyProjectOverviews_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = getMyProjectOverviews_result()
        try:
            result.success = self._handler.getMyProjectOverviews(args.apiKey)
            msg_type = TMessageType.REPLY
        except (TTransport.TTransportException, KeyboardInterrupt, SystemExit):
            raise
        except ServerLogicException as svEx:
            ...
            logging.exception(ex)
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("getMyProjectOverviews", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
...
class createUser_args(object):
    ...
    def __init__(self, apiKey=None, username=None, email=None, password=None,):
        self.apiKey = apiKey
...
class getMyProjectOverviews_args(object):
    """
    Attributes:
     - apiKey
    """
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, (self.__class__, self.thrift_spec)))
            return
        oprot.writeStructBegin('getMyProjectOverviews_args')
        if self.apiKey is not None:
            oprot.writeFieldBegin('apiKey', TType.STRING, 1)
            oprot.writeString(self.apiKey.encode('utf-8') if sys.version_info[0] == 2 else self.apiKey)
            oprot.writeFieldEnd()
...
class getMyProjectOverviews_result(object):
    """
    Attributes:
     - success
     - svEx
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i533 in range(_size529):
                        _elem534 = ProjectOverviewResponse()
                        _elem534.read(iprot)
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, (self.__class__, self.thrift_spec)))
            return
        oprot.writeStructBegin('getMyProjectOverviews_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.LIST, 0)
            oprot.writeListBegin(TType.STRUCT, len(self.success))
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i547 in range(_size543):
                        _elem548 = TransformEvent()
                        _elem548.read(iprot)
                        self.te.append(_elem548)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i554 in range(_size550):
                        _elem555 = TransformEventResponse()
                        _elem555.read(iprot)
